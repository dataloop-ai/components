    ...
    <div>
        ...
        <div style="max-width: 150px">
            ...
            <dl-input-field
                ...
                disabled
            />
            <dl-input-field v-model="textVal" disabled />
            <dl-input-field v-model="textVal" readonly />
        </div>

        <div>
            <div>With auto trim</div>

            <dl-input-field v-model="trimmedValue" auto-trim />
        </div>

        <dl-input-field placeholder="placeholder input readonly" readonly />

        <dl-input-field placeholder="placeholder input disabled" disabled />
        ...
        <div style="align-items: center; width: 250px; overflow: scroll">
            <dl-input-field class="input-parts">
                <template #action>
                    <dl-button dense flat icon="icon-dl-add" size="m" />
                </template>
            </dl-input-field>
...
import { DlInputField, DlButton, DlIcon, DlSwitch } from '../components'
import { DlInputFile } from '../components/compound/DlInput/types'
export default defineComponent({
    name: 'DlInputFieldDemo',
    components: {
        DlSwitch,
        DlInputField,
        DlButton,
