...
type Story = StoryObj<typeof DlGrid>

const meta: Meta<typeof DlGrid> = {
...
export const LayoutModeTemplate: Story = {
...
export const GridModeTemplate: Story = {
    render: (args, { argTypes }) => {
        return {
            components: {
                DlGrid,
...
export const FlexModeTemplate: Story = {
    render: (args, { argTypes }) => {
        return {
            components: {
                DlGrid,
