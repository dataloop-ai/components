...
import {
    ...
    w as window_1,
    a as __rest,
    f as _objectWithoutPropertiesLoose,
    h as _extends,
    i as modifierPhases,
    j as auto,
    s as start,
    ...
    o as end,
    q as popper,
    v as variationPlacements,
    u as basePlacements,
    x as reference,
    y as viewport,
    z as clippingParents
} from './index-e3a020a3.js'
import './es.regexp.flags-4c951918.js'
import { r as reactDomExports } from './index-265fe75c.js'
...
var toPaddingObject = /* @__PURE__ */ __name(function toPaddingObject2(
    padding,
    state
) {
    padding =
...
var eventListeners = {
    ...
    enabled: true,
    phase: 'write',
    fn: /* @__PURE__ */ __name(function fn() {}, 'fn'),
    effect,
    data: {}
}
var hash$1 = {
...
function popperGenerator(generatorOptions) {
    ...
    return /* @__PURE__ */ __name(function createPopper2(
        reference2,
        popper2,
        options
    ) {
        ...
        var instance = {
            state,
            setOptions: /* @__PURE__ */ __name(function setOptions(
                setOptionsAction
            ) {
                var options2 =
...
function _setPrototypeOf(o, p) {
    _setPrototypeOf =
        ...
        /* @__PURE__ */ __name(function _setPrototypeOf2(o2, p2) {
            o2.__proto__ = p2
            return o2
        }, '_setPrototypeOf')
...
var usePopper = /* @__PURE__ */ __name(function usePopper2(
    referenceElement,
    popperElement,
    options
) {
    ...
    var popperOptions = reactExports.useMemo(
        function () {
            var newOptions = {
...
function Popper(_ref) {
    ...
    var options = reactExports.useMemo(
        function () {
            return {
                placement,
                strategy,
    ...
    var childrenProps = reactExports.useMemo(
        function () {
            return {
...
function Reference(_ref) {
    var children = _ref.children,
        innerRef = _ref.innerRef
    var setReferenceNode = reactExports.useContext(
        ManagerReferenceNodeSetterContext
    )
    var refHandler = reactExports.useCallback(
        function (node) {
    ...
    reactExports.useEffect(function () {}, [setReferenceNode])
...
var Tooltip$1 = /* @__PURE__ */ (function (_Component) {
    ...
    _proto.componentDidMount = /* @__PURE__ */ __name(
    ...
    _proto.componentDidUpdate = /* @__PURE__ */ __name(
    ...
    _proto.componentWillUnmount = /* @__PURE__ */ __name(
    ...
    _proto.isTriggeredBy = /* @__PURE__ */ __name(function isTriggeredBy(
        event
    ) {
...
var TooltipTrigger = /* @__PURE__ */ (function (_Component) {
    ...
    function TooltipTrigger2() {
        ...
        _this.clickToggle = function (event) {
            ...
            var pageX = event.pageX,
                pageY = event.pageY
            var action = _this.props.followCursor
                ? 'showTooltip'
                : 'toggleTooltip'
            _this[action]({
                pageX,
    ...
    _proto.render = /* @__PURE__ */ __name(function render() {
        ...
        var popper2 = /* @__PURE__ */ React__default.createElement(
            Popper,
            _extends(
                {
        ...
        return /* @__PURE__ */ React__default.createElement(
            ...
            this.getState() &&
                (usePortal
                    ? /* @__PURE__ */ reactDomExports.createPortal(
                          popper2,
                          portalContainer
                      )
                    : popper2)
...
var Arrow = styled.div(
    ...
    function (_ref7) {
        ...
        return {
            bottom: ''.concat(
                match('top', placement, ArrowSpacing * -1, 'auto'),
                'px'
            ),
            top: ''.concat(
                match('bottom', placement, ArrowSpacing * -1, 'auto'),
                'px'
            ),
            right: ''.concat(
                match('left', placement, ArrowSpacing * -1, 'auto'),
                'px'
            ),
            left: ''.concat(
                match('right', placement, ArrowSpacing * -1, 'auto'),
                'px'
            ),
            borderBottomWidth: ''.concat(
                match('top', placement, '0', ArrowSpacing),
                'px'
            ),
            borderTopWidth: ''.concat(
                match('bottom', placement, '0', ArrowSpacing),
                'px'
            ),
            borderRightWidth: ''.concat(
                match('left', placement, '0', ArrowSpacing),
                'px'
            ),
            borderLeftWidth: ''.concat(
                match('right', placement, '0', ArrowSpacing),
                'px'
            ),
...
var WithToolTipState = /* @__PURE__ */ __name(function WithToolTipState2(_a) {
    ...
    var _useState = reactExports.useState(startOpen || false),
        _useState2 = _slicedToArray(_useState, 2),
        tooltipShown = _useState2[0],
        setTooltipShown = _useState2[1]
    var onVisibilityChange = reactExports.useCallback(
        function (visibility) {
