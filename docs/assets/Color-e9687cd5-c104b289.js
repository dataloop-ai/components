...
function i(e) {
    var t = reactExports.useRef(e),
        n = reactExports.useRef(function (e2) {
...
var s = /* @__PURE__ */ __name(function s2(e, r, t) {
    ...
    f = /* @__PURE__ */ __name(function f2(e) {
        return 'touches' in e
    }, 'f'),
    v = /* @__PURE__ */ __name(function v2(e) {
        return (e && e.ownerDocument.defaultView) || self
    }, 'v'),
    d = /* @__PURE__ */ __name(function d2(e, r, t) {
        var n = e.getBoundingClientRect(),
            o = f(r)
                ? (function (e2, r2) {
                      for (var t2 = 0; t2 < e2.length; t2++) {
                          if (e2[t2].identifier === r2) return e2[t2]
                      }
                      return e2[0]
                  })(r.touches, t)
                : r
    ...
    h = /* @__PURE__ */ __name(function h2(e) {
    ...
    m = React__default.memo(function (o) {
        var a = o.onMove,
            l = o.onKey,
            s3 = c(o, ['onMove', 'onKey']),
            m2 = reactExports.useRef(null),
            g3 = i(a),
            p3 = i(l),
            b3 = reactExports.useRef(null),
            _2 = reactExports.useRef(false),
            x3 = reactExports.useMemo(
                function () {
                    var e = /* @__PURE__ */ __name(function e2(_e) {
                            h(_e),
                                (f(_e)
                                    ? _e.touches.length > 0
                                    : _e.buttons > 0) && m2.current
                                    ? g3(d(m2.current, _e, b3.current))
                                    : t(false)
                        }, 'e'),
                        r = /* @__PURE__ */ __name(function r2() {
                            return t(false)
                        }, 'r')
                    function t(t2) {
                        var n = _2.current,
                            ...
                            a2 = t2
                                ? o2.addEventListener
                                : o2.removeEventListener
                        a2(n ? 'touchmove' : 'mousemove', e),
                            a2(n ? 'touchend' : 'mouseup', r)
                    }
                    __name(t, 't')
                    return [
                        function (e2) {
    ...
    p = /* @__PURE__ */ __name(function p2(r) {
        var t = r.color,
            n = r.left,
            o = r.top,
            a = void 0 === o ? 0.5 : o,
    ...
    b = /* @__PURE__ */ __name(function b2(e, r, t) {
        return (
            void 0 === r && (r = 0),
    ...
    C = /* @__PURE__ */ __name(function C2(e, r) {
        return void 0 === r && (r = 'deg'), Number(e) * (_[r] || 1)
    }, 'C'),
    E = /* @__PURE__ */ __name(function E2(e) {
        var r =
    ...
    M = /* @__PURE__ */ __name(function M2(e) {
        var r = e.s,
            t = e.l
        return {
            h: e.h,
    ...
    N = /* @__PURE__ */ __name(function N2(e) {
        var r = e.s,
            t = e.v,
            n = e.a,
            o = ((200 - r) * t) / 100
    ...
    w = /* @__PURE__ */ __name(function w2(e) {
        var r = N(e)
        return 'hsl(' + r.h + ', ' + r.s + '%, ' + r.l + '%)'
    }, 'w'),
    y = /* @__PURE__ */ __name(function y2(e) {
        var r = N(e)
        return 'hsla(' + r.h + ', ' + r.s + '%, ' + r.l + '%, ' + r.a + ')'
    }, 'y'),
    q = /* @__PURE__ */ __name(function q2(e) {
        var r = e.h,
            t = e.s,
            n = e.v,
            o = e.a
    ...
    I = /* @__PURE__ */ __name(function I2(e) {
        var r =
    ...
    z = /* @__PURE__ */ __name(function z2(e) {
        var r = e.toString(16)
        return r.length < 2 ? '0' + r : r
    }, 'z'),
    B = /* @__PURE__ */ __name(function B2(e) {
        var r = e.r,
            t = e.g,
            n = e.b,
            o = e.a,
    ...
    A = /* @__PURE__ */ __name(function A2(e, r) {
        if (e === r) return true
        for (var t in e) {
            if (e[t] !== r[t]) return false
        }
        return true
    }, 'A'),
    S = /* @__PURE__ */ __name(function S2(e, r) {
        return e.replace(/\s/g, '') === r.replace(/\s/g, '')
    }, 'S')
function T(e, t, l) {
    var u2 = i(l),
        c2 = reactExports.useState(function () {
            return e.toHsva(t)
        }),
        s3 = c2[0],
        f3 = c2[1],
        v3 = reactExports.useRef({
            color: t,
            hsva: s3
        })
    reactExports.useEffect(
        ...
        reactExports.useEffect(
            function () {
                var r
                A(s3, v3.current.hsva) ||
                    e.equal((r = e.fromHsva(s3)), v3.current.color) ||
                    ((v3.current = {
                        hsva: s3,
                        color: r
                    }),
    ...
    var d3 = reactExports.useCallback(function (e2) {
        f3(function (r) {
...
var P =
    ...
    $ = /* @__PURE__ */ __name(function $2(t) {
        var n = t.className,
            o = t.colorModel,
            a = t.color,
            l = void 0 === a ? o.defaultColor : a,
            i2 = t.onChange,
            s3 = c(t, ['className', 'colorModel', 'color', 'onChange']),
            f3 = reactExports.useRef(null)
        V(f3)
        var v3 = T(o, l, i2),
            d3 = v3[0],
            h3 = v3[1],
            m2 = g(['react-colorful', n])
        return React__default.createElement(
            'div',
            u({}, s3, {
                ref: f3,
    ...
    Q = /* @__PURE__ */ __name(function Q2(r) {
        var t = r.className,
            n = r.hsva,
            o = r.onChange,
            a = {
    ...
    U = /* @__PURE__ */ __name(function U2(t) {
        var n = t.className,
            o = t.colorModel,
            a = t.color,
            l = void 0 === a ? o.defaultColor : a,
...
var reverseKeywords = {}
for (
    var _i = 0, _Object$keys = Object.keys(cssKeywords);
...
for (
    var _i2 = 0, _Object$keys2 = Object.keys(convert$1);
...
function comparativeDistance(x3, y3) {
    return (
        Math.pow(x3[0] - y3[0], 2) +
        Math.pow(x3[1] - y3[1], 2) +
        Math.pow(x3[2] - y3[2], 2)
    )
}
...
convert$1.rgb.keyword = function (rgb) {
    ...
    for (
        var _i3 = 0, _Object$keys3 = Object.keys(cssKeywords);
...
var Swatch = /* @__PURE__ */ __name(function Swatch2(_a) {
    ...
    var backgroundImage = 'linear-gradient('
        .concat(value, ', ')
        .concat(value, '), ')
...
var stringToArgs = /* @__PURE__ */ __name(function stringToArgs2(value) {
    var match =
        value === null || value === void 0 ? void 0 : value.match(COLOR_REGEXP)
...
var parseValue = /* @__PURE__ */ __name(function parseValue2(value) {
    ...
    if (RGB_REGEXP.test(value)) {
        ...
        return (
            ...
            _defineProperty(_ref7, ColorSpace.RGB, value),
            _defineProperty(
                _ref7,
                ColorSpace.HSL,
                'hsla('
    ...
    else if (HEX_REGEXP.test(value)) mapped = '#'.concat(plain)
...
var getRealValue = /* @__PURE__ */ __name(function getRealValue2(
    value,
    color,
    colorSpace
) {
    ...
    var _short$1$split = short[1].split(''),
        ...
        r = _short$1$split2[0],
        g3 = _short$1$split2[1],
        b3 = _short$1$split2[2]
    return '#'.concat(r).concat(r).concat(g3).concat(g3).concat(b3).concat(b3)
},
'getRealValue')
var useColorInput = /* @__PURE__ */ __name(function useColorInput2(
    initialValue,
    onChange
) {
    ...
    var realValue = reactExports.useMemo(
        function () {
            return getRealValue(value, color, colorSpace).toLowerCase()
        },
        [value, color, colorSpace]
    )
    var updateValue = reactExports.useCallback(
        function (update) {
    ...
    var cycleColorSpace = reactExports.useCallback(
        function () {
...
var usePresets = /* @__PURE__ */ __name(function usePresets2(
    presetColors,
    currentColor,
    colorSpace
) {
    var _useState7 = reactExports.useState(
            (
                currentColor === null || currentColor === void 0
                    ? void 0
                    : currentColor.valid
            )
                ? [currentColor]
    ...
    reactExports.useEffect(
        function () {
            if (currentColor !== void 0) return
            setSelectedColors([])
        },
        [currentColor]
    )
    var presets = reactExports.useMemo(
        function () {
    ...
    var addPreset = reactExports.useCallback(
        function (color) {
