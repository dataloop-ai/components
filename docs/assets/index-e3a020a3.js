...
var __name = (target, value2) =>
    __defProp(target, 'name', { value: value2, configurable: true })
import {
    _ as _export,
    c as createHtml,
    s as stringHtmlForced,
    a as stringTrim,
    b as stringTrimForced,
    t as toIntegerOrInfinity$2,
    d as toLength$2,
    o as objectGetOwnPropertyNames,
    e as objectDefineProperty,
    g as global$3,
    f as functionUncurryThis,
    h as descriptors,
    i as createNonEnumerableProperty$1,
    j as defineBuiltIns$1,
    k as fails$1,
    l as anInstance$1,
    m as objectGetPrototypeOf,
    n as objectSetPrototypeOf,
    p as arrayFill$1,
    q as setToStringTag$1,
    r as functionName,
    u as arraySliceSimple,
    v as internalState,
    w as setSpecies$1,
    x as stringRepeat,
    y as styled,
...
var stringTrimEnd = forcedStringTrimMethod('trimEnd')
...
var addGetter = /* @__PURE__ */ __name(function (Constructor, key2) {
    defineProperty$2(Constructor[PROTOTYPE], key2, {
        get: function () {
            return getInternalState(this)[key2]
        }
    })
}, 'addGetter')
var get$2 = /* @__PURE__ */ __name(function (
    view,
    count,
    index2,
    isLittleEndian
...
'get$2')
var set = /* @__PURE__ */ __name(function (
    view,
    count,
    index2,
    conversion,
...
if (!NATIVE_ARRAY_BUFFER) {
    ...
    $DataView = /* @__PURE__ */ __name(function DataView2(
        ...
        byteLength =
            byteLength === void 0 ? bufferLength - offset : toLength(byteLength)
    ...
    defineBuiltIns(DataViewPrototype, {
        ...
        setUint16: /* @__PURE__ */ __name(function setUint16(
            byteOffset,
            value2
        ) {
            set(
        ...
        setUint32: /* @__PURE__ */ __name(function setUint32(
            byteOffset,
            value2
        ) {
            set(
        ...
        'setUint32'),
        setFloat32: /* @__PURE__ */ __name(function setFloat32(
            byteOffset,
            value2
        ) {
            set(
        ...
        'setFloat32'),
        setFloat64: /* @__PURE__ */ __name(function setFloat64(
            byteOffset,
            value2
        ) {
            set(
    ...
    if (
        ...
        for (
            var keys$5 = getOwnPropertyNames(NativeArrayBuffer$1), j$1 = 0, key;
            keys$5.length > j$1;
    ...
    if (testView.getInt8(0) || !testView.getInt8(1))
        defineBuiltIns(
            DataViewPrototype,
            {
                setInt8: /* @__PURE__ */ __name(function setInt8(
                    byteOffset,
                    value2
                ) {
                ...
                'setInt8'),
                setUint8: /* @__PURE__ */ __name(function setUint8(
                    byteOffset,
                    value2
                ) {
                    $setInt8(this, byteOffset, (value2 << 24) >> 24)
...
function _setPrototypeOf2(o2, p3) {
    _setPrototypeOf2 =
        ...
        /* @__PURE__ */ __name(function _setPrototypeOf3(o3, p4) {
            o3.__proto__ = p4
            return o3
        }, '_setPrototypeOf')
...
function _getPrototypeOf2(o2) {
    _getPrototypeOf2 = Object.setPrototypeOf
        ...
        : /* @__PURE__ */ __name(function _getPrototypeOf3(o3) {
...
function _slicedToArray$4(arr, i2) {
    return (
        ...
        _iterableToArrayLimit$4(arr, i2) ||
        _unsupportedIterableToArray$5(arr, i2) ||
        _nonIterableRest$4()
    )
}
...
function __rest(s2, e2) {
    ...
    if (s2 != null && typeof Object.getOwnPropertySymbols === 'function')
        for (
            var i2 = 0, p3 = Object.getOwnPropertySymbols(s2);
            i2 < p3.length;
            i2++
        ) {
            if (
                e2.indexOf(p3[i2]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(s2, p3[i2])
            )
                t[p3[i2]] = s2[p3[i2]]
        }
    return t
...
var nameSpaceClassNames = /* @__PURE__ */ __name(function nameSpaceClassNames2(
    _a,
    key2
) {
    var props = __rest(_a, [])
    ...
    delete props.class
    props.className = ['sbdocs', 'sbdocs-'.concat(key2)]
        .concat(classes)
        .filter(Boolean)
        .join(' ')
    return props
...
__name(_extends$1$1, '_extends$1$1')
...
function _construct(Parent, args, Class) {
    if (_isNativeReflectConstruct()) {
        ...
        _construct = /* @__PURE__ */ __name(function _construct2(
            Parent2,
            args2,
            Class2
        ) {
...
function _wrapNativeSuper(Class) {
    ...
    _wrapNativeSuper = /* @__PURE__ */ __name(function _wrapNativeSuper2(
        Class2
    ) {
...
function opacify(amount, color) {
    ...
    var colorWithAlpha = _extends$1$1({}, parsedColor, {
...
function transparentize(amount, color) {
    ...
    var colorWithAlpha = _extends$1$1({}, parsedColor, {
        alpha: guard(
            0,
            1,
            +(alpha2 * 100 - parseFloat(amount) * 100).toFixed(2) / 100
        )
    })
    return rgba(colorWithAlpha)
}
...
var LazySyntaxHighlighter = reactExports.lazy(function () {
    return __vitePreload(
        () => import('./syntaxhighlighter-75381027-2cdbcbbf.js'),
        true
            ? [
                  'assets/syntaxhighlighter-75381027-2cdbcbbf.js',
                  'assets/iframe-dd92afcf.js',
                  'assets/iframe-377882c4.css'
              ]
            : void 0
    )
})
var LazySyntaxHighlighterWithFormatter = reactExports.lazy(function () {
    return __awaiter(
        void 0,
        void 0,
        void 0,
                        ...
                        while (1) {
                            switch ((_context.prev = _context.next)) {
                                case 0:
                                    ...
                                    return Promise.all([
                                        __vitePreload(
                                            () =>
                                                import(
                                                    './syntaxhighlighter-75381027-2cdbcbbf.js'
                                                ),
                                            true
                                                ? [
                                                      'assets/syntaxhighlighter-75381027-2cdbcbbf.js',
                                        ...
                                        __vitePreload(
                                            () =>
                                                import(
                                                    './formatter-c2d2643c-8b50311f.js'
                                                ),
                                            true
                                                ? [
                                                      'assets/formatter-c2d2643c-8b50311f.js',
                                                      'assets/iframe-dd92afcf.js',
                                                      'assets/iframe-377882c4.css',
                                                      'assets/es.regexp.flags-4c951918.js'
                                                  ]
                                                : void 0
                                        )
                                    ])
                                case 2:
                                    ...
                                    _yield$Promise$all2 = _slicedToArray$4(
                                        _yield$Promise$all,
                                        2
                                    )
                                    SyntaxHighlighter3 =
...
var SyntaxHighlighter = /* @__PURE__ */ __name(function SyntaxHighlighter2(
    props
) {
    return React__default.createElement(
...
var Source$1 = /* @__PURE__ */ __name(function Source2(props) {
    ...
    var syntaxHighlighter = React__default.createElement(
...
var isReactChildString = /* @__PURE__ */ __name(function isReactChildString2(
    child
) {
...
var Code = /* @__PURE__ */ __name(function Code2(_a) {
    ...
    var isInlineCode = !childrenArray
...
var Icons = reactExports.memo(function (_a) {
    var icon = _a.icon,
        symbol = _a.symbol,
    ...
    return React__default.createElement(
        ...
        symbol
            ...
            : React__default.createElement(Path, { d: icons[icon] })
    )
})
reactExports.memo(function (_ref28) {
    var _ref28$icons = _ref28.icons,
        keys2 = _ref28$icons === void 0 ? Object.keys(icons) : _ref28$icons
    return React__default.createElement(
        'svg',
        {
        ...
        keys2.map(function (key2) {
            return React__default.createElement(
                'symbol',
                { id: 'icon--'.concat(key2), key: key2 },
                React__default.createElement(Path, { d: icons[key2] })
            )
        })
    )
})
...
var Link = /* @__PURE__ */ __name(function Link2(_a) {
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            ...
            children,
            withArrow &&
                React__default.createElement(Icons, { icon: 'arrowright' })
        )
    )
}, 'Link')
Link.defaultProps = {
...
var ActionBar = /* @__PURE__ */ __name(function ActionBar2(_a) {
    ...
    return React__default.createElement(
        Container$1,
        Object.assign({}, props),
        actionItems.map(function (_ref40, index2) {
            ...
            return (
                ...
                React__default.createElement(
                    ActionButton,
                    { key: index2, className, onClick, disabled },
                    title
                )
            )
        })
...
styled.div(
    function (_ref41) {
        var theme = _ref41.theme,
            ...
            row = _ref41$row === void 0 ? 1 : _ref41$row
        return col
            ? _defineProperty2(
                  {
                      display: 'inline-block',
...
var Placeholder = /* @__PURE__ */ __name(function Placeholder2(_a) {
    ...
    var _Children$toArray = reactExports.Children.toArray(children),
        _Children$toArray2 = _slicedToArray$4(_Children$toArray, 2),
        title = _Children$toArray2[0],
        desc = _Children$toArray2[1]
    return React__default.createElement(
        Message$1,
        Object.assign({}, props),
        React__default.createElement(Title$3, null, title),
        desc && React__default.createElement(Desc$1, null, desc)
    )
}, 'Placeholder')
var GlobalScrollAreaStyles = reactExports.lazy(function () {
    return __vitePreload(
        () => import('./GlobalScrollAreaStyles-8793ce4a-2a0f34b9.js'),
        true
            ? [
                  'assets/GlobalScrollAreaStyles-8793ce4a-2a0f34b9.js',
                  'assets/iframe-dd92afcf.js',
                  'assets/iframe-377882c4.css'
              ]
            : void 0
...
var OverlayScrollbars = reactExports.lazy(function () {
    return __vitePreload(
        () => import('./OverlayScrollbars-d54f9566-090f6d43.js'),
        true
            ? [
                  'assets/OverlayScrollbars-d54f9566-090f6d43.js',
                  'assets/iframe-dd92afcf.js',
                  'assets/iframe-377882c4.css'
              ]
            : void 0
...
var ScrollArea = styled(Scroller)(
    function (_ref47) {
...
var ZoomElementWrapper = styled.div(function (_ref49) {
    var _ref49$scale = _ref49.scale,
        scale = _ref49$scale === void 0 ? 1 : _ref49$scale,
...
function ZoomElement(_ref50) {
    ...
    var componentWrapperRef = reactExports.useRef(null)
...
var ZoomIFrame = /* @__PURE__ */ (function (_Component) {
    ...
    _createClass(ZoomIFrame2, [
        ...
        },
        {
            ...
            value: /* @__PURE__ */ __name(function shouldComponentUpdate(
                nextProps
            ) {
        ...
        },
        {
            ...
            value: /* @__PURE__ */ __name(function setIframeInnerZoom(scale) {
                try {
        ...
        {
            key: 'setIframeZoom',
            value: /* @__PURE__ */ __name(function setIframeZoom(scale) {
...
var ButtonWrapper = styled.button(
    function (_ref51) {
        ...
        return {
            ...
            display: 'inline-block',
            overflow: 'hidden',
            padding: small2 ? '8px 16px' : '13px 20px',
            position: 'relative',
            textAlign: 'center',
            textDecoration: 'none',
            transition: 'all 150ms ease-out',
        ...
        return tertiary
            ? Object.assign(
                  Object.assign(
                      ...
                      inForm && small2 ? { padding: '10px 16px' } : {}
                  ),
                  {
                      '&:hover': Object.assign(
                          {
...
var useComposedRef = /* @__PURE__ */ __name(function useComposedRef2(
    libRef,
    userRef
) {
...
var forceHiddenStyles = /* @__PURE__ */ __name(function forceHiddenStyles2(
    node
) {
...
var noop$2 = /* @__PURE__ */ __name(function noop2() {}, 'noop')
...
var useWindowResizeListener = /* @__PURE__ */ __name(
    function useWindowResizeListener2(listener) {
...
var TextareaAutosize = /* @__PURE__ */ __name(function TextareaAutosize2(
    _ref,
    userRef
) {
    var cacheMeasurements = _ref.cacheMeasurements,
        ...
        onHeightChange =
            _ref$onHeightChange === void 0 ? noop$2 : _ref$onHeightChange,
        props = _objectWithoutPropertiesLoose$3(_ref, [
            'cacheMeasurements',
            'maxRows',
            'minRows',
            'onChange',
    ...
    return /* @__PURE__ */ reactExports.createElement(
        'textarea',
        _extends$4({}, props, { onChange: handleChange, ref })
    )
},
'TextareaAutosize')
var index$2 = /* @__PURE__ */ reactExports.forwardRef(TextareaAutosize)
...
var Textarea = Object.assign(
    styled(
        ...
        var _ref65$height = _ref65.height,
            height = _ref65$height === void 0 ? 400 : _ref65$height
...
var Button$1 = Object.assign(
    reactExports.forwardRef(function (props, ref) {
        return React__default.createElement(
            ButtonStyled,
            Object.assign(
                {},
...
var LazyWithTooltip = reactExports.lazy(function () {
    return __vitePreload(
        () => import('./WithTooltip-5d9955be-834a4e8c.js'),
        true
            ? [
                  'assets/WithTooltip-5d9955be-834a4e8c.js',
                  'assets/iframe-dd92afcf.js',
                  'assets/iframe-377882c4.css',
                  'assets/es.regexp.flags-4c951918.js',
                  'assets/index-265fe75c.js'
              ]
            : void 0
    ).then(function (mod) {
...
var WithTooltip = /* @__PURE__ */ __name(function WithTooltip2(props) {
    return React__default.createElement(
        reactExports.Suspense,
        { fallback: React__default.createElement('div', null) },
        React__default.createElement(LazyWithTooltip, Object.assign({}, props))
    )
}, 'WithTooltip')
var LazyWithTooltipPure = reactExports.lazy(function () {
    return __vitePreload(
        () => import('./WithTooltip-5d9955be-834a4e8c.js'),
        true
            ? [
...
styled.div(function (_ref67) {
    ...
    return {
        marginTop: 8,
        textAlign: 'center',
        '> *': { margin: '0 8px', fontWeight: theme.typography.weight.black }
    }
})
...
var similar = Similar
var mapOrSimilar = /* @__PURE__ */ __name(function mapOrSimilar2(forceSimilar) {
...
var memoizerific = /* @__PURE__ */ __name(function memoizerific2(limit) {
    var cache = new MapOrSimilar({}.FORCE_SIMILAR_INSTEAD_OF_MAP === 'true'),
        lru = []
    return function (fn) {
        var memoizerific3 = /* @__PURE__ */ __name(function memoizerific4() {
            var currentCache = cache,
                ...
                i2
            if (
                (memoizerific4.numArgs || memoizerific4.numArgs === 0) &&
            ...
            for (i2 = 0; i2 < argsLengthMinusOne; i2++) {
                ...
                newMap = new MapOrSimilar(
                    {}.FORCE_SIMILAR_INSTEAD_OF_MAP === 'true'
                )
...
var Bar$1 = styled(function (_ref85) {
    ...
    return React__default.createElement(
        ScrollArea,
        { horizontal: true, vertical: false, className },
        children
    )
})(
    function (_ref86) {
...
var FlexBar = /* @__PURE__ */ __name(function FlexBar2(_a) {
    ...
    var _Children$toArray3 = reactExports.Children.toArray(children),
        _Children$toArray4 = _slicedToArray$4(_Children$toArray3, 2),
        left2 = _Children$toArray4[0],
        right2 = _Children$toArray4[1]
    return React__default.createElement(
        Bar$1,
        Object.assign({}, rest),
        React__default.createElement(
            ...
            React__default.createElement(Side, { left: true }, left2),
            right2
                ? React__default.createElement(Side, { right: true }, right2)
                : null
        )
    )
}, 'FlexBar')
...
var childrenToList = /* @__PURE__ */ __name(function childrenToList2(
    children,
    selected
) {
    return reactExports.Children.toArray(children).map(function (
        _ref102,
        index2
    ) {
        ...
        var content = Array.isArray(childrenOfChild)
            ? childrenOfChild[0]
            : childrenOfChild
        return {
            active: selected ? id === selected : index2 === 0,
            title,
            id,
            color,
            render:
...
'childrenToList')
var Tabs = reactExports.memo(function (_ref104) {
...
var TabsState = /* @__PURE__ */ (function (_Component2) {
    ...
    function TabsState2(props) {
        ...
        _this3.handlers = {
            onSelect: /* @__PURE__ */ __name(function onSelect(id) {
    ...
    _createClass(TabsState2, [
        {
            ...
            value: /* @__PURE__ */ __name(function render() {
                var _this$props2 = this.props,
                    ...
                    bordered =
                        _this$props2$bordered === void 0
                            ? false
                            : _this$props2$bordered,
                    _this$props2$absolute = _this$props2.absolute,
                    absolute =
                        _this$props2$absolute === void 0
                            ? false
                            : _this$props2$absolute,
...
function pt(t, e2, n2) {
    ...
    var c2 = [[]]
    return (
        o2.forEach(function (t2, e3) {
            'tableSeparator' === t2.type
                ? 0 !== e3 && e3 !== o2.length - 1 && c2.push([])
                : ('text' !== t2.type ||
                      (null != o2[e3 + 1] &&
                          'tableSeparator' !== o2[e3 + 1].type) ||
                      (t2.content = t2.content.replace(U, '')),
                  c2[c2.length - 1].push(t2))
        }),
        c2
    )
}
...
function gt(t, e2, n2) {
    n2.o = true
    var r2 = pt(t[1], e2, n2),
        o2 = t[2].replace(q, '').split('|').map(dt),
        c2 = (function (t2, e3, n3) {
            return t2
                .trim()
                .split('\n')
                .map(function (t3) {
...
function Bt(r2) {
    ...
    ;(q2.overrides = q2.overrides || {}),
        (q2.slugify = q2.slugify || ft),
        (q2.namedCodesToUnicode = q2.namedCodesToUnicode
            ? e({}, c, q2.namedCodesToUnicode)
            : c)
    ...
    function V2(t, n2) {
        ...
        for (
            var _len4 = arguments.length,
                r3 = new Array(_len4 > 2 ? _len4 - 2 : 0),
                _key4 = 2;
            _key4 < _len4;
            _key4++
        ) {
        ...
        return U2.apply(
            ...
            [
                (function (t2, e2) {
                    ...
                    return n3
                        ? 'function' == typeof n3 ||
                          ('object' == _typeof(n3) && 'render' in n3)
                            ? n3
                            : Mt(e2, ''.concat(t2, '.component'), t2)
                        : t2
                })(t, q2.overrides),
                e({}, n2, o2, {
                    className:
                        It(null == n2 ? void 0 : n2.className, o2.className) ||
                        void 0
                })
            ].concat(r3)
        )
    ...
    function W2(e2) {
        ...
        q2.forceInline
            ? (n2 = true)
            : q2.forceBlock || (n2 = false === P.test(e2))
        var r3 = pt2(
            dt2(n2 ? e2 : ''.concat(e2.trimEnd().replace(et, ''), '\n\n'), {
                o: n2
            })
        )
        for (
            ;
            'string' == typeof r3[r3.length - 1] && !r3[r3.length - 1].trim();

        ) {
            r3.pop()
        }
        if (null === q2.wrapper) return r3
        var o2 = q2.wrapper || (n2 ? 'span' : 'div')
        var c2
        if (r3.length > 1 || q2.forceWrapper) c2 = r3
        else {
            if (1 === r3.length)
                return (
                    (c2 = r3[0]),
                    'string' == typeof c2
                        ? V2('span', { key: 'outer' }, c2)
                        : c2
                )
            c2 = null
        }
            ...
            ? r3.reduce(function (e3, r4, c2) {
                  ...
                  if (-1 !== a3) {
                      var _u = (function (t) {
                          ...
                          _l = o[_u] || _u,
                          _s2 = (e3[_l] = (function (t, e4) {
                              return 'style' === t
                                  ? e4.split(/;\s?/).reduce(function (t2, e5) {
                                  ...
                                  ? bt(e4)
                                  : (e4.match(I) &&
                                        (e4 = e4.slice(1, e4.length - 1)),
                                    'true' === e4 || ('false' !== e4 && e4))
                          })(_u, _i2))
                      'string' == typeof _s2 &&
                          (w.test(_s2) || R.test(_s2)) &&
                          (e3[_l] = React__default.cloneElement(
                              W2(_s2.trim()),
                              { key: c2 }
                          ))
                  } else 'style' !== r4 && (e3[o[r4] || r4] = true)
                  return e3
              }, {})
            : void 0
    }
    ...
    var rt2 = [],
        ...
        st2 = {
            blockQuote: {
                i: kt(s),
                l: Ot.HIGH,
                _: /* @__PURE__ */ __name(function _(t, e2, n2) {
                    return { content: e2(t[0].replace(_2, ''), n2) }
                }, '_'),
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
            ...
            codeBlock: {
                i: kt(g),
                l: Ot.MAX,
                _: /* @__PURE__ */ __name(function _(t) {
                    return {
                        content: t[0]
                            .replace(/^ {4}/gm, '')
                            .replace(/\n+$/, ''),
            ...
            footnoteReference: {
                ...
                _: /* @__PURE__ */ __name(function _(t) {
                    return {
                        content: t[1],
                        target: '#'.concat(q2.slugify(t[1]))
                    }
                }, '_'),
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
                    return V2(
                        'a',
                        { key: n2.g, href: bt(t.target) },
                        V2('sup', { key: n2.g }, t.content)
                    )
                }, 'p')
            },
            gfmTask: {
            ...
            heading: {
                ...
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
                    return (
                        ...
                        V2(t.tag, { id: t.id, key: n2.g }, e2(t.content, n2))
                    )
                }, 'p')
            },
            headingSetext: {
            ...
            link: {
                ...
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
                    return V2(
                        'a',
                        { key: n2.g, href: bt(t.target), title: t.title },
                        e2(t.content, n2)
                    )
                }, 'p')
            },
            ...
            linkBareUrlDetector: {
                i: /* @__PURE__ */ __name(function i2(t, e2) {
            ...
            linkMailtoDetector: {
                ...
                _: /* @__PURE__ */ __name(function _(t) {
                    var e2 = t[1],
                        n2 = t[1]
                    return (
                        i.test(n2) || (n2 = 'mailto:' + n2),
                        {
                            content: [
                                {
                                    content: e2.replace('mailto:', ''),
                                    type: 'text'
                                }
                            ],
                            target: n2,
            ...
            list: {
                i: /* @__PURE__ */ __name(function i2(t, e2, n2) {
                    var r3 = T.exec(n2)
                    return !r3 || (!e2.h && e2.o)
                        ? null
                        : at.exec((t = r3[1] + t))
                ...
                _: /* @__PURE__ */ __name(function _(t, e2, n2) {
                    ...
                    var u2 = false
                    return {
                        items: a3.map(function (t2, r4) {
                            var o3 = ot.exec(t2)[0].length,
                                c3 = new RegExp('^ {1,' + o3 + '}', 'gm'),
                                i2 = t2.replace(c3, '').replace(ot, ''),
                                l2 = r4 === a3.length - 1,
                                s2 = -1 !== i2.indexOf('\n\n') || (l2 && u2)
                            u2 = s2
                            var _3 = n2.o,
                ...
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
                    return V2(
                        t.ordered ? 'ol' : 'ul',
                        { key: n2.g, start: t.start },
                        t.items.map(function (t2, r3) {
            ...
            refImage: {
                ...
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
                    return V2('img', {
                        key: n2.g,
                        alt: t.alt,
                        src: bt(ut2[t.ref].target),
                        title: ut2[t.ref].title
                    })
                }, 'p')
            },
            refLink: {
                ...
                _: /* @__PURE__ */ __name(function _(t, e2, n2) {
                    return {
                        content: e2(t[1], n2),
                        fallbackContent: e2(t[0].replace(F, '\\$1'), n2),
                        ref: t[2]
                    }
                }, '_'),
                p: /* @__PURE__ */ __name(function p3(t, e2, n2) {
                    return ut2[t.ref]
                        ? V2(
                              ...
                              {
                                  key: n2.g,
                                  href: bt(ut2[t.ref].target),
                                  title: ut2[t.ref].title
                              },
                              e2(t.content, n2)
                          )
                        : V2('span', { key: n2.g }, e2(t.fallbackContent, n2))
                }, 'p')
            },
            table: {
                i: kt(C),
                    ...
                    return V2(
                        ...
                        V2(
                            ...
                            V2(
                                'tr',
                                null,
                                t.header.map(function (r3, o2) {
                                    return V2(
                                        'th',
                                        { key: o2, style: mt(t, o2) },
                                        e2(r3, n2)
                                    )
                                })
                            )
                        ...
                        V2(
                            'tbody',
                            null,
                            t.cells.map(function (r3, o2) {
                                return V2(
                                    'tr',
                                    { key: o2 },
                                    r3.map(function (r4, o3) {
                                        return V2(
                                            'td',
                                            { key: o3, style: mt(t, o3) },
                                            e2(r4, n2)
                                        )
                                    })
                                )
            ...
            text: {
                ...
                _: /* @__PURE__ */ __name(function _(t) {
                    return {
                        content: t[0].replace(z, function (t2, e2) {
                            return q2.namedCodesToUnicode[e2]
                                ? q2.namedCodesToUnicode[e2]
                                : t2
                        })
                    }
                }, '_'),
                p: /* @__PURE__ */ __name(function p3(t) {
                    return t.content
                }, 'p')
            },
            textBolded: {
    ...
    true !== q2.disableParsingRawHTML &&
        ((st2.htmlBlock = {
            i: xt(w),
            l: Ot.HIGH,
            _: /* @__PURE__ */ __name(function _(t, e2, n2) {
                var _t$3$match = t[3].match(nt),
                    _t$3$match2 = _slicedToArray$4(_t$3$match, 2),
                    r3 = _t$3$match2[1],
                    o2 = new RegExp('^'.concat(r3), 'gm'),
                    c2 = t[3].replace(o2, ''),
                    u2 =
                        ((i2 = c2),
                        _t.some(function (t2) {
            ...
            p: /* @__PURE__ */ __name(function p3(t, n2, r3) {
                return V2(
                    t.tag,
                    e({ key: r3.g }, t.attrs),
                    t.noInnerParse ? t.content : n2(t.content, r3)
                )
            }, 'p')
        }),
        (st2.htmlSelfClosing = {
        ...
        ? V2(
              ...
              V2(
                  ...
                  rt2.map(function (t) {
                      return V2(
                          'div',
                          { id: q2.slugify(t.identifier), key: t.identifier },
                          t.identifier,
                          pt2(dt2(t.footnote, { o: true }))
                      )
                  })
              )
          )
...
var Description$1 = /* @__PURE__ */ __name(function Description$12(_ref110) {
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            Markdown,
            { options: { forceBlock: true, overrides: components$1 } },
            markdown
        )
    )
}, 'Description$1')
...
var getBlockBackgroundStyle = /* @__PURE__ */ __name(
    function getBlockBackgroundStyle2(theme) {
        return {
            borderRadius: theme.appBorderRadius,
            background: theme.background.content,
            boxShadow:
...
var getStoryHref = /* @__PURE__ */ __name(function getStoryHref2(
    baseUrl,
    storyId
) {
    ...
    var _baseUrl$split = baseUrl.split('?'),
        _baseUrl$split2 = _slicedToArray$4(_baseUrl$split, 2),
        url = _baseUrl$split2[0],
        paramsStr = _baseUrl$split2[1]
    var params = paramsStr
        ? Object.assign(
              Object.assign(
                  Object.assign({}, lib.parse(paramsStr)),
                  additionalParams
              ),
              { id: storyId }
          )
    ...
    return ''
        .concat(url)
        .concat(lib.stringify(params, { addQueryPrefix: true, encode: false }))
},
'getStoryHref')
...
var IFrame = /* @__PURE__ */ (function (_Component3) {
    ...
    _createClass(IFrame2, [
        ...
        },
        {
            ...
            value: /* @__PURE__ */ __name(function setIframeBodyStyle(style) {
...
var LoaderWrapper = styled.div(function (_ref120) {
    var _ref120$size = _ref120.size,
        size = _ref120$size === void 0 ? 32 : _ref120$size
    return {
        borderRadius: '50%',
        cursor: 'progress',
        display: 'inline-block',
...
var PureLoader = /* @__PURE__ */ __name(function PureLoader2(_a) {
    ...
    if (error2) {
        return React__default.createElement(
            ...
            React__default.createElement(ProgressMessage, null, error2.message)
        )
    }
    if (progress) {
        ...
        return React__default.createElement(
            ...
            React__default.createElement(
                ...
                message,
                _value < 1 &&
                    React__default.createElement(Ellipsis, { key: message })
            )
        )
    }
    return React__default.createElement(
...
var Loader = /* @__PURE__ */ __name(function Loader2(props) {
    ...
    var _useState5 = reactExports.useState(void 0),
        _useState6 = _slicedToArray$4(_useState5, 2),
        error2 = _useState6[0],
        setError = _useState6[1]
    reactExports.useEffect(function () {
        if (CONFIG_TYPE !== 'DEVELOPMENT' || !EventSource) return void 0
    ...
    return React__default.createElement(
        PureLoader,
        Object.assign({ progress, error: error2 }, props)
    )
}, 'Loader')
...
var InlineStory = /* @__PURE__ */ __name(function InlineStory2(_ref125) {
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            ...
            null,
            storyFn
                ? reactExports.createElement(storyFn)
                : React__default.createElement(
                      EmptyBlock,
                      null,
                      MISSING_STORY(id)
...
var IFrameStory = /* @__PURE__ */ __name(function IFrameStory2(_ref126) {
    var id = _ref126.id,
        ...
        height = _ref126$height === void 0 ? '500px' : _ref126$height
    return React__default.createElement(
        'div',
...
var Story$1 = /* @__PURE__ */ __name(function Story2(_a) {
    ...
    return inline
        ? React__default.createElement(InlineStory, Object.assign({}, props))
        : React__default.createElement(IFrameStory, { id, title, height })
}, 'Story')
...
var ChildrenContainer = styled.div(
    ...
    function (_ref129) {
        var _ref129$layout = _ref129.layout,
            layout = _ref129$layout === void 0 ? 'padded' : _ref129$layout
    ...
    function (_ref130) {
        var _ref130$layout = _ref130.layout,
            layout = _ref130$layout === void 0 ? 'padded' : _ref130$layout
...
var getSource = /* @__PURE__ */ __name(function getSource2(
    withSource,
    expanded,
    setExpanded
) {
        ...
        case expanded: {
            return {
                source: React__default.createElement(
                    StyledSource,
                    Object.assign({}, withSource, { dark: true })
                ),
                actionItem: {
                    title: 'Hide code',
                    className:
...
var getLayout = /* @__PURE__ */ __name(function getLayout2(children) {
    return children.reduce(function (result2, c2) {
        ...
        return (
            (c2.props && c2.props.parameters && c2.props.parameters.layout) ||
            'padded'
        )
    }, void 0)
}, 'getLayout')
var Preview$1 = /* @__PURE__ */ __name(function Preview2(_a) {
    var isLoading = _a.isLoading,
        ...
        withToolbar = _a$withToolbar === void 0 ? false : _a$withToolbar,
    ...
    var _useState7 = reactExports.useState(isExpanded),
    ...
    var _useState9 = reactExports.useState(1),
    ...
    var _useState11 = reactExports.useState(
            additionalActions ? _toConsumableArray$1(additionalActions) : []
        ),
        _useState12 = _slicedToArray$4(_useState11, 2),
        additionalActionItems = _useState12[0],
        setAdditionalActionItems = _useState12[1]
    var actionItems = [].concat(
        defaultActionItems,
        _toConsumableArray$1(additionalActionItems)
    )
    var layout = getLayout(
        reactExports.Children.count(children) === 1 ? [children] : children
    )
    var globalWindow2 = window_1.window
    var copyToClipboard = reactExports.useCallback(function (text) {
        return __awaiter(
            void 0,
            void 0,
            void 0,
            /* @__PURE__ */ regeneratorRuntime.mark(
                /* @__PURE__ */ __name(function _callee2() {
        ...
        if (
            ...
            copyToClipboard(source.props.code).then(function () {
                setAdditionalActionItems(
                    [].concat(_toConsumableArray$1(additionalActionItems), [
                        {
                            title: 'Copied',
                            onClick: /* @__PURE__ */ __name(
                                function onClick() {},
    ...
    return React__default.createElement(
        ...
        withToolbar &&
            React__default.createElement(PositionedToolbar, {
                isLoading,
                border: true,
                zoom: /* @__PURE__ */ __name(function zoom(z2) {
                    return setScale(scale * z2)
                }, 'zoom'),
                resetZoom: /* @__PURE__ */ __name(function resetZoom() {
                    return setScale(1)
                }, 'resetZoom'),
                storyId: getStoryId$1(children),
                baseUrl: './iframe.html'
            }),
        React__default.createElement(
            ...
            React__default.createElement(
                ...
                React__default.createElement(ActionBar, { actionItems })
            )
        ),
...
var PreviewSkeleton = /* @__PURE__ */ __name(function PreviewSkeleton2() {
    return React__default.createElement(
        StyledPreview,
        { isLoading: true, withToolbar: true },
...
function listCacheDelete$1(key2) {
    var data = this.__data__,
        index2 = assocIndexOf$3(data, key2)
    if (index2 < 0) {
        return false
    }
...
function listCacheGet$1(key2) {
    var data = this.__data__,
        index2 = assocIndexOf$2(data, key2)
...
function getRawTag$1(value2) {
    var isOwn = hasOwnProperty$b.call(value2, symToStringTag$1),
...
function hashHas$1(key2) {
    ...
    return nativeCreate$1
        ? data[key2] !== void 0
        : hasOwnProperty$8.call(data, key2)
}
...
function equalByTag$1(
    ...
    switch (tag) {
        ...
        case arrayBufferTag$3:
            if (
                object2.byteLength != other.byteLength ||
                !equalFunc(new Uint8Array$1(object2), new Uint8Array$1(other))
            ) {
                return false
            }
            return true
        ...
        case symbolTag$3:
            if (symbolValueOf$1) {
                return (
                    symbolValueOf$1.call(object2) == symbolValueOf$1.call(other)
                )
            }
    }
    return false
...
function baseGetAllKeys$2(object2, keysFunc, symbolsFunc) {
    ...
    return isArray$8(object2)
        ? result2
        : arrayPush$1(result2, symbolsFunc(object2))
}
...
var isArguments$2 = baseIsArguments(
    ...
    : function (value2) {
          return (
              isObjectLike$5(value2) &&
              hasOwnProperty$7.call(value2, 'callee') &&
...
function baseIsTypedArray$1(value2) {
    return (
        isObjectLike$4(value2) &&
        isLength$2(value2.length) &&
        !!typedArrayTags[baseGetTag$2(value2)]
    )
}
...
function arrayLikeKeys$2(value2, inherited) {
    ...
    for (var key2 in value2) {
        if (
            (inherited || hasOwnProperty$6.call(value2, key2)) &&
            !(
...
if (
    ...
    getTag$4 = /* @__PURE__ */ __name(function getTag$42(value2) {
        var result2 = baseGetTag$1(value2),
            Ctor = result2 == objectTag$2 ? value2.constructor : void 0,
...
function baseIsEqualDeep$1(
    ...
    var objIsArr = isArray$6(object2),
    ...
    if (!(bitmask & COMPARE_PARTIAL_FLAG$2)) {
        var objIsWrapped =
                objIsObj && hasOwnProperty$3.call(object2, '__wrapped__'),
            othIsWrapped =
...
function baseIsEqual$2(value2, other, bitmask, customizer, stack) {
    ...
    if (
        value2 == null ||
        other == null ||
        (!isObjectLike$3(value2) && !isObjectLike$3(other))
    ) {
...
function isSymbol$3(value2) {
    return (
        _typeof(value2) == 'symbol' ||
        (isObjectLike$2(value2) && baseGetTag(value2) == symbolTag$2)
    )
}
...
function hasPath$1(object2, path, hasFunc) {
    ...
    return (
        ...
        (isArray$2(object2) || isArguments(object2))
    )
}
...
function assignValue$3(object2, key2, value2) {
    var objValue = object2[key2]
    if (
        !(hasOwnProperty$2.call(object2, key2) && eq(objValue, value2)) ||
        (value2 === void 0 && !(key2 in object2))
    ) {
...
function baseKeysIn$1(object2) {
    ...
    for (var key2 in object2) {
        if (
            !(
                key2 == 'constructor' &&
                (isProto || !hasOwnProperty$1.call(object2, key2))
            )
        ) {
            result2.push(key2)
        }
                ...
                params.map(function (x2) {
                    return React__default.createElement(
                        ...
                        React__default.createElement(
                            'td',
                            null,
                            React__default.createElement('code', null, x2.name)
                        ),
                        React__default.createElement('td', null, x2.description)
                    )
                }),
...
function baseIndexOf$1(array2, value2, fromIndex) {
    return value2 === value2
        ? strictIndexOf(array2, value2, fromIndex)
...
function baseUniq$1(array2, iteratee, comparator) {
    ...
    outer: while (++index2 < length) {
        var value2 = array2[index2],
            computed = iteratee ? iteratee(value2) : value2
...
var Text$2 = styled.span(codeCommon, function (_ref138) {
    var theme = _ref138.theme,
        ...
        simple = _ref138$simple === void 0 ? false : _ref138$simple
    return Object.assign(
        {
            flex: '0 0 auto',
            fontFamily: theme.typography.fonts.mono,
...
var getSummaryItems = /* @__PURE__ */ __name(function getSummaryItems2(
    summary
) {
...
'getSummaryItems')
var renderSummaryItems = /* @__PURE__ */ __name(function renderSummaryItems2(
    summaryItems
) {
    var isExpanded =
...
var ArgSummary = /* @__PURE__ */ __name(function ArgSummary2(_ref143) {
    var value2 = _ref143.value,
        initialExpandedArgs = _ref143.initialExpandedArgs
    var summary = value2.summary,
        detail = value2.detail
    var _useState13 = reactExports.useState(false),
        _useState14 = _slicedToArray$4(_useState13, 2),
        isOpen = _useState14[0],
        setIsOpen = _useState14[1]
    var _useState15 = reactExports.useState(initialExpandedArgs || false),
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            ...
            React__default.createElement('span', null, summaryAsString),
...
var getControlSetterButtonId = /* @__PURE__ */ __name(
    function getControlSetterButtonId2(value2) {
...
var parseDate = /* @__PURE__ */ __name(function parseDate2(value2) {
    var _value$split = value2.split('-'),
        _value$split2 = _slicedToArray$4(_value$split, 3),
...
var parseTime = /* @__PURE__ */ __name(function parseTime2(value2) {
    var _value$split3 = value2.split(':'),
        _value$split4 = _slicedToArray$4(_value$split3, 2),
...
var DateControl = /* @__PURE__ */ __name(function DateControl2(_ref148) {
    ...
    return React__default.createElement(
        ...
        !valid ? React__default.createElement('div', null, 'invalid') : null
    )
}, 'DateControl')
...
var NumberControl = /* @__PURE__ */ __name(function NumberControl2(_ref149) {
    ...
    var onForceVisible = reactExports.useCallback(
        function () {
            setInputValue('0')
            onChange(0)
    ...
    var htmlElRef = reactExports.useRef(null)
    reactExports.useEffect(
        function () {
...
var selectedKey = /* @__PURE__ */ __name(function selectedKey2(
    value2,
    options
) {
    var entry =
...
'selectedKey')
var selectedKeys = /* @__PURE__ */ __name(function selectedKeys2(
    value2,
    options
) {
...
'selectedKeys')
var selectedValues = /* @__PURE__ */ __name(function selectedValues2(
    keys2,
    options
) {
    return (
...
var CheckboxControl = /* @__PURE__ */ __name(function CheckboxControl2(
    _ref153
) {
    var name = _ref153.name,
        options = _ref153.options,
        value2 = _ref153.value,
    ...
    var _useState25 = reactExports.useState(initial),
    ...
    return React__default.createElement(
        Wrapper$4,
        { isInline },
        Object.keys(options).map(function (key2, index2) {
                ...
                React__default.createElement('input', {
                    ...
                    checked:
                        selected === null || selected === void 0
                            ? void 0
                            : selected.includes(key2)
                }),
                React__default.createElement(Text$1, null, key2)
            )
        })
    )
},
    ...
    return React__default.createElement(
        ...
        Object.keys(options).map(function (key2, index2) {
            ...
            return React__default.createElement(
                ...
                React__default.createElement(Text, null, key2)
            )
        })
    )
}, 'RadioControl')
...
var MultiSelect = /* @__PURE__ */ __name(function MultiSelect2(_ref158) {
    var name = _ref158.name,
        value2 = _ref158.value,
        options = _ref158.options,
        onChange = _ref158.onChange
    var handleChange = /* @__PURE__ */ __name(function handleChange2(e2) {
        var selection2 = Array.from(e2.currentTarget.options)
...
var SelectControl = /* @__PURE__ */ __name(function SelectControl2(props) {
    ...
    return props.isMulti
        ? React__default.createElement(MultiSelect, Object.assign({}, props))
        : React__default.createElement(SingleSelect, Object.assign({}, props))
}, 'SelectControl')
var normalizeOptions = /* @__PURE__ */ __name(function normalizeOptions2(
    options,
    labels
) {
...
function copyObject$4(source, props, object2, customizer) {
    ...
    while (++index2 < length) {
        ...
        var newValue = customizer
            ? customizer(object2[key2], source[key2], key2, object2, source)
            : void 0
        if (newValue === void 0) {
...
function initCloneArray$1(array2) {
    ...
    if (
        ...
        hasOwnProperty$c.call(array2, 'index')
    ) {
...
function baseClone$1(value2, bitmask, customizer, key2, object2, stack) {
    ...
    if (customizer) {
        result2 = object2
            ? customizer(value2, key2, object2, stack)
            : customizer(value2)
    }
    if (result2 !== void 0) {
        return result2
    ...
    if (isArr) {
        ...
        if (tag == objectTag || tag == argsTag || (isFunc && !object2)) {
            ...
            if (!isDeep) {
                return isFlat
                    ? copySymbolsIn(value2, baseAssignIn(result2, value2))
                    : copySymbols(value2, baseAssign(result2, value2))
            }
        } else {
...
var JsonAddValue = /* @__PURE__ */ (function (_Component4) {
    ...
    _createClass(JsonAddValue2, [
        ...
        {
            key: 'onSubmit',
            value: /* @__PURE__ */ __name(function onSubmit() {
                var _this$props3 = this.props,
                    handleAdd = _this$props3.handleAdd,
                    onlyValue = _this$props3.onlyValue,
                    onSubmitValueParser2 = _this$props3.onSubmitValueParser,
                ...
                result2.newValue = onSubmitValueParser2(
                    false,
                    keyPath,
                    deep,
                    result2.key,
        ...
        {
            key: 'refInputKey',
            value: /* @__PURE__ */ __name(function refInputKey(node) {
                this.state.inputRefKey = node
            }, 'refInputKey')
        },
        {
            key: 'refInputValue',
            value: /* @__PURE__ */ __name(function refInputValue(node) {
        ...
        },
        {
            ...
            value: /* @__PURE__ */ __name(function render() {
                ...
                var addButtonElementLayout = reactExports.cloneElement(
                    addButtonElement,
                    { onClick: this.onSubmit }
                )
                var cancelButtonElementLayout = reactExports.cloneElement(
                    cancelButtonElement,
                    { onClick: handleCancel }
                )
                var inputElementValue = inputElementGenerator(
                    VALUE,
                    keyPath,
                    deep
                )
                var inputElementValueLayout = reactExports.cloneElement(
                    inputElementValue,
                ...
                if (!onlyValue) {
                    ...
                    inputElementKeyLayout = reactExports.cloneElement(
                        inputElementKey,
...
var JsonArray = /* @__PURE__ */ (function (_Component5) {
    ...
    function JsonArray2(props) {
        ...
        var keyPath = [].concat(_toConsumableArray$1(props.keyPath), [
            props.name
        ])
        _this6.state = {
            data: props.data,
    ...
    _createClass(
        ...
        [
            {
                key: 'onChildUpdate',
                value: /* @__PURE__ */ __name(function onChildUpdate(
                    childKey,
                    childData
                ) {
            ...
            {
                key: 'handleAddMode',
                value: /* @__PURE__ */ __name(function handleAddMode() {
                    this.setState({ addFormVisible: true })
                }, 'handleAddMode')
            },
            {
                key: 'handleCollapseMode',
                value: /* @__PURE__ */ __name(function handleCollapseMode() {
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleRemoveItem(
                    index2
                ) {
                    var _this7 = this
                    return function () {
                        var _this7$props = _this7.props,
                            beforeRemoveAction2 =
                                _this7$props.beforeRemoveAction,
                            logger2 = _this7$props.logger
                        ...
                        beforeRemoveAction2(index2, keyPath, deep, oldValue)
                            .then(function () {
                                ...
                                var _this7$props2 = _this7.props,
                                    ...
                                    onDeltaUpdate2 = _this7$props2.onDeltaUpdate
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleAddValueAdd(
                    _ref159
                ) {
                    var _this8 = this
                    ...
                    var _this$props5 = this.props,
                        beforeAddAction2 = _this$props5.beforeAddAction,
                        logger2 = _this$props5.logger
                    beforeAddAction2(data.length, keyPath, deep, newValue)
                        .then(function () {
                            var newData = [].concat(
                                _toConsumableArray$1(data),
                                [newValue]
                            )
                            ...
                            var _this8$props = _this8.props,
                                ...
                                onDeltaUpdate2 = _this8$props.onDeltaUpdate
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleAddValueCancel() {
                    this.setState({ addFormVisible: false })
                }, 'handleAddValueCancel')
            },
            {
                key: 'handleEditValue',
                value: /* @__PURE__ */ __name(function handleEditValue(
                    _ref160
                ) {
                    var _this9 = this
                    var key2 = _ref160.key,
                        value2 = _ref160.value
                    return new Promise(function (resolve, reject) {
                        var beforeUpdateAction2 =
                            _this9.props.beforeUpdateAction
                        ...
                        beforeUpdateAction2(
                            ...
                            .then(function () {
                                ...
                                var _this9$props = _this9.props,
                                    ...
                                    onDeltaUpdate2 = _this9$props.onDeltaUpdate
                                onUpdate(keyPath[keyPath.length - 1], data)
                                onDeltaUpdate2({
            ...
            {
                key: 'renderCollapsed',
                value: /* @__PURE__ */ __name(function renderCollapsed() {
                    ...
                    var _this$props6 = this.props,
                        ...
                        readOnly2 = _this$props6.readOnly,
                        getStyle2 = _this$props6.getStyle,
                        dataType = _this$props6.dataType,
                        minusMenuElement = _this$props6.minusMenuElement
                    var _getStyle = getStyle2(
                            name,
                            data,
                            keyPath,
                            deep,
                    ...
                    var removeItemButton = reactExports.cloneElement(
                        minusMenuElement,
                        {
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function renderNotCollapsed() {
                    var _this10 = this
                    ...
                    var _this$props7 = this.props,
                        isCollapsed2 = _this$props7.isCollapsed,
                        handleRemove = _this$props7.handleRemove,
                        onDeltaUpdate2 = _this$props7.onDeltaUpdate,
                        readOnly2 = _this$props7.readOnly,
                        getStyle2 = _this$props7.getStyle,
                        ...
                        inputElementGenerator =
                            _this$props7.inputElementGenerator,
                        ...
                        beforeRemoveAction2 = _this$props7.beforeRemoveAction,
                        beforeAddAction2 = _this$props7.beforeAddAction,
                        beforeUpdateAction2 = _this$props7.beforeUpdateAction,
                        logger2 = _this$props7.logger,
                        onSubmitValueParser2 = _this$props7.onSubmitValueParser
                    var _getStyle2 = getStyle2(
                            name,
                            data,
                            keyPath,
                            deep,
                    ...
                    var addItemButton = reactExports.cloneElement(
                        plusMenuElement,
                        {
                        ...
                        React__default.createElement(
                            ...
                            data.map(function (item, index2) {
                                return React__default.createElement(JsonNode, {
                                    ...
                                    minusMenuElement,
                                    plusMenuElement,
                                    beforeRemoveAction: beforeRemoveAction2,
                                    beforeAddAction: beforeAddAction2,
                                    beforeUpdateAction: beforeUpdateAction2,
                                    logger: logger2,
                                    onSubmitValueParser: onSubmitValueParser2
                                })
                            })
                        ),
                        !isReadOnly &&
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function render() {
                    ...
                    var _this$props8 = this.props,
                        ...
                        getStyle2 = _this$props8.getStyle
                    var value2 = collapsed
        ...
        [
            {
                ...
                value: /* @__PURE__ */ __name(function getDerivedStateFromProps(
                    props,
                    state
                ) {
...
var JsonFunctionValue = /* @__PURE__ */ (function (_Component6) {
    ...
    _createClass(
        ...
        [
            ...
            {
                key: 'handleEdit',
                value: /* @__PURE__ */ __name(function handleEdit() {
                    var _this12 = this
                    var _this$props10 = this.props,
                        handleUpdateValue3 = _this$props10.handleUpdateValue,
                        originalValue = _this$props10.originalValue,
                        logger2 = _this$props10.logger,
                        onSubmitValueParser2 =
                            _this$props10.onSubmitValueParser,
                    ...
                    if (!inputRef) return
                    var newValue = onSubmitValueParser2(
                        true,
                        keyPath,
                        deep,
                        name,
            ...
            {
                key: 'handleEditMode',
                value: /* @__PURE__ */ __name(function handleEditMode() {
                    this.setState({ editEnabled: true })
                }, 'handleEditMode')
            },
            {
                key: 'refInput',
                value: /* @__PURE__ */ __name(function refInput(node) {
                    this.state.inputRef = node
                }, 'refInput')
            },
            {
                key: 'handleCancelEdit',
                value: /* @__PURE__ */ __name(function handleCancelEdit() {
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function render() {
                    ...
                    var _this$props11 = this.props,
                        ...
                        readOnly2 = _this$props11.readOnly,
                        dataType = _this$props11.dataType,
                        getStyle2 = _this$props11.getStyle,
                    ...
                    var resultOnlyResult = readOnly2(
                        name,
                        originalValue,
                        keyPath,
                        deep,
                    ...
                    if (editEnabled && !resultOnlyResult) {
                        var textareaElement2 = textareaElementGenerator(
                            VALUE,
                            comeFromKeyPath,
                            deep,
                            name,
                        ...
                        var editButtonElementLayout = reactExports.cloneElement(
                            editButtonElement,
                            { onClick: this.handleEdit }
                        )
                        var cancelButtonElementLayout =
                            reactExports.cloneElement(cancelButtonElement, {
                                onClick: this.handleCancelEdit
                            })
                        var textareaElementLayout = reactExports.cloneElement(
                            textareaElement2,
                            { ref: this.refInput, defaultValue: originalValue }
                        )
                        result2 = React__default.createElement(
                            'span',
                            {
                        ...
                        var minusMenuLayout = reactExports.cloneElement(
                            minusMenuElement,
                            {
                                onClick: handleRemove,
                                className: 'rejt-minus-menu',
...
JsonFunctionValue.defaultProps = {
    keyPath: [],
    deep: 0,
    handleUpdateValue: /* @__PURE__ */ __name(function handleUpdateValue() {},
    'handleUpdateValue'),
        ...
        [
            {
                ...
                value: /* @__PURE__ */ __name(function render() {
                    ...
                    var _this$props12 = this.props,
                        isCollapsed2 = _this$props12.isCollapsed,
                        handleRemove = _this$props12.handleRemove,
                        handleUpdateValue3 = _this$props12.handleUpdateValue,
                        onUpdate = _this$props12.onUpdate,
                        onDeltaUpdate2 = _this$props12.onDeltaUpdate,
                        readOnly2 = _this$props12.readOnly,
                        getStyle2 = _this$props12.getStyle,
                        ...
                        inputElementGenerator =
                            _this$props12.inputElementGenerator,
                        textareaElementGenerator =
                        ...
                        beforeRemoveAction2 = _this$props12.beforeRemoveAction,
                        beforeAddAction2 = _this$props12.beforeAddAction,
                        beforeUpdateAction2 = _this$props12.beforeUpdateAction,
                        logger2 = _this$props12.logger,
                        onSubmitValueParser2 = _this$props12.onSubmitValueParser
                    var readOnlyTrue = /* @__PURE__ */ __name(
                        function readOnlyTrue2() {
                            return true
                        },
                        'readOnlyTrue'
                    )
                    ...
                    switch (dataType) {
                        ...
                        case STRING:
                            return React__default.createElement(JsonValue, {
                                ...
                                deep,
                                handleRemove,
                                handleUpdateValue: handleUpdateValue3,
                                readOnly: readOnly2,
                                dataType,
                                getStyle: getStyle2,
                                cancelButtonElement,
...
var JsonObject = /* @__PURE__ */ (function (_Component8) {
    ...
    function JsonObject2(props) {
        ...
        var keyPath =
            props.deep === -1
                ? []
                : [].concat(_toConsumableArray$1(props.keyPath), [props.name])
        _this14.state = {
            name: props.name,
            data: props.data,
            keyPath,
    ...
    _createClass(
        ...
        [
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleAddValueAdd(
                    ...
                    var _this$props13 = this.props,
                        beforeAddAction2 = _this$props13.beforeAddAction,
                        logger2 = _this$props13.logger
                    beforeAddAction2(key2, keyPath, deep, newValue)
                        .then(function () {
                            data[key2] = newValue
                            ...
                            var _this15$props = _this15.props,
                                ...
                                onDeltaUpdate2 = _this15$props.onDeltaUpdate
                            onUpdate(keyPath[keyPath.length - 1], data)
                            onDeltaUpdate2({
                                type: ADD_DELTA_TYPE,
                                keyPath,
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleRemoveValue(key2) {
                    var _this16 = this
                    return function () {
                        var _this16$props = _this16.props,
                            beforeRemoveAction2 =
                                _this16$props.beforeRemoveAction,
                            logger2 = _this16$props.logger
                        var _this16$state = _this16.state,
                            data = _this16$state.data,
                            keyPath = _this16$state.keyPath,
                            deep = _this16$state.nextDeep
                        var oldValue = data[key2]
                        beforeRemoveAction2(key2, keyPath, deep, oldValue)
                            .then(function () {
                                var deltaUpdateResult = {
                                    keyPath,
                                    deep,
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleEditValue(
                    ...
                    var _this17 = this
                    var key2 = _ref162.key,
                        value2 = _ref162.value
                    return new Promise(function (resolve, reject) {
                        var beforeUpdateAction2 =
                            _this17.props.beforeUpdateAction
                        var _this17$state = _this17.state,
                        ...
                        beforeUpdateAction2(
                            ...
                            .then(function () {
                                ...
                                var _this17$props = _this17.props,
                                    ...
                                    onDeltaUpdate2 = _this17$props.onDeltaUpdate
                                onUpdate(keyPath[keyPath.length - 1], data)
                                onDeltaUpdate2({
                                    type: UPDATE_DELTA_TYPE,
                                    keyPath,
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function renderCollapsed() {
                    ...
                    var _this$props14 = this.props,
                        ...
                        readOnly2 = _this$props14.readOnly,
                        dataType = _this$props14.dataType,
                        getStyle2 = _this$props14.getStyle,
                        minusMenuElement = _this$props14.minusMenuElement
                    var _getStyle3 = getStyle2(
                            name,
                            data,
                            keyPath,
                            deep,
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function renderNotCollapsed() {
                    ...
                    var _this$props15 = this.props,
                        isCollapsed2 = _this$props15.isCollapsed,
                        handleRemove = _this$props15.handleRemove,
                        onDeltaUpdate2 = _this$props15.onDeltaUpdate,
                        readOnly2 = _this$props15.readOnly,
                        getStyle2 = _this$props15.getStyle,
                        ...
                        inputElementGenerator =
                            _this$props15.inputElementGenerator,
                        textareaElementGenerator =
                        ...
                        beforeRemoveAction2 = _this$props15.beforeRemoveAction,
                        beforeAddAction2 = _this$props15.beforeAddAction,
                        beforeUpdateAction2 = _this$props15.beforeUpdateAction,
                        logger2 = _this$props15.logger,
                        onSubmitValueParser2 = _this$props15.onSubmitValueParser
                    var _getStyle4 = getStyle2(
                            name,
                            data,
                            keyPath,
                            deep,
                    ...
                    var list = keyList.map(function (key2) {
                        return React__default.createElement(JsonNode, {
                            ...
                            deep: nextDeep,
                            isCollapsed: isCollapsed2,
                            handleRemove: _this18.handleRemoveValue(key2),
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function render() {
                    ...
                    var _this$props16 = this.props,
                        getStyle2 = _this$props16.getStyle,
        ...
        [
            {
                ...
                value: /* @__PURE__ */ __name(function componentDidUpdate() {
                    var _this$state17 = this.state,
                        ...
                        value2 = _this$state17.value,
                        keyPath = _this$state17.keyPath,
                        deep = _this$state17.deep
                    var _this$props17 = this.props,
                        readOnly2 = _this$props17.readOnly,
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function handleEdit() {
                    ...
                    var _this$props18 = this.props,
                        handleUpdateValue3 = _this$props18.handleUpdateValue,
                        originalValue = _this$props18.originalValue,
                        logger2 = _this$props18.logger,
                        onSubmitValueParser2 =
                            _this$props18.onSubmitValueParser,
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function render() {
                    ...
                    var inputElement2 = inputElementGenerator(
                        VALUE,
                        comeFromKeyPath,
                        deep,
                        name,
                    ...
                    var inputElementLayout = reactExports.cloneElement(
                        inputElement2,
                        {
                            ref: this.refInput,
...
JsonValue.defaultProps = {
    keyPath: [],
    deep: 0,
    handleUpdateValue: /* @__PURE__ */ __name(function handleUpdateValue2() {
...
var JsonTree = /* @__PURE__ */ (function (_Component10) {
    ...
    _createClass(
        ...
        [
            {
                key: 'onUpdate',
                value: /* @__PURE__ */ __name(function onUpdate(key2, data) {
                    this.setState({ data })
            ...
            {
                key: 'removeRoot',
                value: /* @__PURE__ */ __name(function removeRoot() {
            ...
            },
            {
                ...
                value: /* @__PURE__ */ __name(function render() {
                    ...
                    var _this$props20 = this.props,
                        isCollapsed2 = _this$props20.isCollapsed,
                        onDeltaUpdate2 = _this$props20.onDeltaUpdate,
                        readOnly2 = _this$props20.readOnly,
                        getStyle2 = _this$props20.getStyle,
                        ...
                        inputElement2 = _this$props20.inputElement,
                        textareaElement2 = _this$props20.textareaElement,
                        minusMenuElement = _this$props20.minusMenuElement,
                        plusMenuElement = _this$props20.plusMenuElement,
                        beforeRemoveAction2 = _this$props20.beforeRemoveAction,
                        beforeAddAction2 = _this$props20.beforeAddAction,
                        beforeUpdateAction2 = _this$props20.beforeUpdateAction,
                        logger2 = _this$props20.logger,
                        onSubmitValueParser2 =
                            _this$props20.onSubmitValueParser,
                        _this$props20$fallbac = _this$props20.fallback,
                        fallback =
                            _this$props20$fallbac === void 0
                                ? null
                                : _this$props20$fallbac
                    var dataType = getObjectType(data)
                    var readOnlyFunction = readOnly2
                    if (getObjectType(readOnly2) === 'Boolean') {
                        readOnlyFunction = /* @__PURE__ */ __name(
                            function readOnlyFunction2() {
                                return readOnly2
                            },
                            'readOnlyFunction'
                        )
                    ...
                    if (
                        inputElement2 &&
                        getObjectType(inputElement2) !== 'Function'
                    ) {
                        inputElementFunction = /* @__PURE__ */ __name(
                            function inputElementFunction2() {
                    ...
                    if (
                        textareaElement2 &&
                        getObjectType(textareaElement2) !== 'Function'
                    ) {
                        textareaElementFunction = /* @__PURE__ */ __name(
                            function textareaElementFunction2() {
...
JsonTree.defaultProps = {
    rootName: 'root',
    isCollapsed: /* @__PURE__ */ __name(function isCollapsed(keyPath, deep) {
        return deep !== -1
    }, 'isCollapsed'),
    getStyle: /* @__PURE__ */ __name(function getStyle(
        keyName,
        data,
        keyPath,
        deep,
    ...
    'getStyle'),
    readOnly: /* @__PURE__ */ __name(function readOnly() {
        return false
    }, 'readOnly'),
    onFullyUpdate: /* @__PURE__ */ __name(function onFullyUpdate() {},
    'onFullyUpdate'),
    onDeltaUpdate: /* @__PURE__ */ __name(function onDeltaUpdate() {},
    'onDeltaUpdate'),
    beforeRemoveAction: /* @__PURE__ */ __name(function beforeRemoveAction() {
        return Promise.resolve()
    }, 'beforeRemoveAction'),
    beforeAddAction: /* @__PURE__ */ __name(function beforeAddAction() {
        return Promise.resolve()
    }, 'beforeAddAction'),
    beforeUpdateAction: /* @__PURE__ */ __name(function beforeUpdateAction() {
        return Promise.resolve()
    }, 'beforeUpdateAction'),
    logger: { error: /* @__PURE__ */ __name(function error() {}, 'error') },
    onSubmitValueParser: /* @__PURE__ */ __name(function onSubmitValueParser(
        isEditMode,
        keyPath,
        deep,
        name,
    ...
    'onSubmitValueParser'),
    inputElement: /* @__PURE__ */ __name(function inputElement() {
        return React__default.createElement('input', null)
    }, 'inputElement'),
    textareaElement: /* @__PURE__ */ __name(function textareaElement() {
...
var dispatchEnterKey = /* @__PURE__ */ __name(function dispatchEnterKey2(
    event
) {
...
var getCustomStyleFunction = /* @__PURE__ */ __name(
    function getCustomStyleFunction2(theme) {
        return function () {
            return {
...
var ObjectControl = /* @__PURE__ */ __name(function ObjectControl2(_ref169) {
    var name = _ref169.name,
        value2 = _ref169.value,
        onChange = _ref169.onChange
    var theme = useTheme()
    var data = reactExports.useMemo(
        function () {
    ...
    var _useState31 = reactExports.useState(false),
        _useState32 = _slicedToArray$4(_useState31, 2),
    ...
    var rawJSONForm = React__default.createElement(RawInput, {
        ref: htmlElRef,
        id: getControlId(name),
        name,
    ...
    return React__default.createElement(
        ...
        !showRaw
            ? React__default.createElement(JsonTree, {
                  ...
                  inputElement: /* @__PURE__ */ __name(function inputElement2(
                      _,
                      __,
                      ___,
                      key2
...
var RangeControl = /* @__PURE__ */ __name(function RangeControl2(_ref171) {
    var name = _ref171.name,
        value2 = _ref171.value,
        onChange = _ref171.onChange,
        _ref171$min = _ref171.min,
        min = _ref171$min === void 0 ? 0 : _ref171$min,
        _ref171$max = _ref171.max,
        max = _ref171$max === void 0 ? 100 : _ref171$max,
        _ref171$step = _ref171.step,
        step = _ref171$step === void 0 ? 1 : _ref171$step,
    ...
    var numberOFDecimalsPlaces = reactExports.useMemo(
        function () {
    ...
    return React__default.createElement(
        RangeWrapper,
        null,
        React__default.createElement(RangeLabel, null, min),
        React__default.createElement(
            RangeInput,
            Object.assign(
                {
        ...
        React__default.createElement(
            RangeLabel,
            null,
            ''.concat(hasValue ? value2.toFixed(numberOFDecimalsPlaces) : '--'),
            ' / ',
            max
        )
    )
...
var TextControl = /* @__PURE__ */ __name(function TextControl2(_ref172) {
    ...
    var _useState33 = reactExports.useState(false),
        _useState34 = _slicedToArray$4(_useState33, 2),
...
var FilesControl = /* @__PURE__ */ __name(function FilesControl2(_ref173) {
    var onChange = _ref173.onChange,
        ...
        accept = _ref173$accept === void 0 ? 'image/*' : _ref173$accept,
        value2 = _ref173.value
...
var LazyColorControl = reactExports.lazy(function () {
    return __vitePreload(
        () => import('./Color-e9687cd5-c104b289.js'),
        true
            ? [
                  'assets/Color-e9687cd5-c104b289.js',
                  'assets/iframe-dd92afcf.js',
                  'assets/iframe-377882c4.css'
              ]
            : void 0
...
var ColorControl = /* @__PURE__ */ __name(function ColorControl2(props) {
    return React__default.createElement(
        reactExports.Suspense,
        { fallback: React__default.createElement('div', null) },
        React__default.createElement(LazyColorControl, Object.assign({}, props))
    )
}, 'ColorControl')
var Controls = {
    array: ObjectControl,
...
var ArgControl = /* @__PURE__ */ __name(function ArgControl2(_ref174) {
    ...
    var key2 = row.key,
        control = row.control
    var _useState35 = reactExports.useState(false),
        _useState36 = _slicedToArray$4(_useState35, 2),
        isFocused = _useState36[0],
        setFocused = _useState36[1]
    var _useState37 = reactExports.useState({ value: arg }),
        _useState38 = _slicedToArray$4(_useState37, 2),
...
var ArgRow = /* @__PURE__ */ __name(function ArgRow2(props) {
    ...
    var required =
        (_a = row.type) === null || _a === void 0 ? void 0 : _a.required
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            StyledTd$1,
            { expandable },
            React__default.createElement(Name, null, name),
            required
                ? React__default.createElement(
                      Required,
                      { title: 'Required' },
...
var SectionRow = /* @__PURE__ */ __name(function SectionRow2(_ref186) {
    var _ref186$level = _ref186.level,
        level = _ref186$level === void 0 ? 'section' : _ref186$level,
        label = _ref186.label,
        children = _ref186.children,
        _ref186$initialExpand = _ref186.initialExpanded,
        initialExpanded =
            _ref186$initialExpand === void 0 ? true : _ref186$initialExpand,
        _ref186$colSpan = _ref186.colSpan,
        colSpan = _ref186$colSpan === void 0 ? 3 : _ref186$colSpan
    var _useState39 = reactExports.useState(initialExpanded),
        _useState40 = _slicedToArray$4(_useState39, 2),
        ...
        React__default.createElement(
            ...
            React__default.createElement(
                ...
                React__default.createElement(
                    FlexWrapper,
                    null,
                    React__default.createElement(ExpanderIcon, { icon }),
                    label
                )
            ),
            React__default.createElement(
...
;(function (ArgsTableError2) {
    ...
    ArgsTableError2['ARGS_UNSUPPORTED'] =
        'Args unsupported. See Args documentation for your framework.'
})(ArgsTableError || (ArgsTableError = {}))
var sortFns = {
    alpha: /* @__PURE__ */ __name(function alpha(a3, b2) {
        return a3.name.localeCompare(b2.name)
    }, 'alpha'),
    requiredFirst: /* @__PURE__ */ __name(function requiredFirst(a3, b2) {
        var _a, _b
        return (
            Number(
                !!((_a = b2.type) === null || _a === void 0
                    ? void 0
                    : _a.required)
            ) -
                Number(
                    !!((_b = a3.type) === null || _b === void 0
                        ? void 0
                        : _b.required)
                ) || a3.name.localeCompare(b2.name)
        )
    }, 'requiredFirst'),
    none: void 0
}
...
var groupRows = /* @__PURE__ */ __name(function groupRows2(rows, sort) {
    ...
    Object.entries(rows).forEach(function (_ref191) {
        var _ref192 = _slicedToArray$4(_ref191, 2),
            key2 = _ref192[0],
            row = _ref192[1]
        var _ref193 =
    ...
    var sortSubsection = /* @__PURE__ */ __name(function sortSubsection2(
        record
    ) {
...
var safeIncludeConditionalArg = /* @__PURE__ */ __name(
    function safeIncludeConditionalArg2(row, args, globals) {
        try {
...
var ArgsTable$1 = /* @__PURE__ */ __name(function ArgsTable2(props) {
    ...
    var _ref194 = 'rows' in props ? props : argsTableLoadingData,
        rows = _ref194.rows,
        args = _ref194.args,
    ...
    var groups = groupRows(
        pickBy_1(rows, function (row) {
            var _a
            return (
                !((_a = row === null || row === void 0 ? void 0 : row.table) ===
                    null || _a === void 0
                    ? void 0
                    : _a.disable) &&
        ...
        React__default.createElement(
            ...
            React__default.createElement(
                ...
                Object.entries(groups.ungroupedSubsections).map(function (
                    ...
                    var _ref196 = _slicedToArray$4(_ref195, 2),
                ...
                Object.entries(groups.sections).map(function (_ref197) {
                    var _ref198 = _slicedToArray$4(_ref197, 2),
                        category = _ref198[0],
                        section = _ref198[1]
                    return React__default.createElement(
                        SectionRow,
                        ...
                        Object.entries(section.subsections).map(function (
                            ...
                            var _ref200 = _slicedToArray$4(_ref199, 2),
...
var TabbedArgsTable = /* @__PURE__ */ __name(function TabbedArgsTable2(_a) {
    ...
    return React__default.createElement(
        ...
        entries.map(function (entry) {
            var _entry = _slicedToArray$4(entry, 2),
                label = _entry[0],
                table2 = _entry[1]
    ...
    return React__default.createElement(
        ...
        fontSizes.map(function (size) {
            return React__default.createElement(
                TypeSpecimen,
                { key: size },
                React__default.createElement(Label, null, size),
                React__default.createElement(
                    Sample,
                    {
                        style: {
...
function renderSwatch(color, index2) {
    return React__default.createElement(Swatch, {
        key: ''.concat(color, '-').concat(index2),
        title: color,
        background: color
    })
}
...
function renderSwatchLabel(color, index2, colorDescription) {
    return React__default.createElement(
        SwatchLabel,
        { key: ''.concat(color, '-').concat(index2), title: color },
        React__default.createElement(
            'div',
            null,
            color,
            colorDescription &&
                React__default.createElement('span', null, colorDescription)
        )
    )
}
...
function renderSwatchSpecimen(colors) {
    if (Array.isArray(colors)) {
        return React__default.createElement(
            ...
            React__default.createElement(
                SwatchColors,
                null,
                colors.map(function (color, index2) {
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            SwatchColors,
            null,
            Object.values(colors).map(function (color, index2) {
                return renderSwatch(color, index2)
            })
        ),
        React__default.createElement(
            SwatchLabels,
            null,
            Object.keys(colors).map(function (color, index2) {
...
var ColorItem = /* @__PURE__ */ __name(function ColorItem2(_ref212) {
    ...
    return React__default.createElement(
        ...
        React__default.createElement(
            ItemDescription,
            null,
            React__default.createElement(ItemTitle, null, title),
            React__default.createElement(ItemSubtitle, null, subtitle)
        ),
        React__default.createElement(
            Swatches,
            null,
...
var IconItem = /* @__PURE__ */ __name(function IconItem2(_ref215) {
    ...
    return React__default.createElement(
        Item,
        null,
        React__default.createElement(ItemSpecimen, null, children),
        React__default.createElement(ItemLabel, null, name)
    )
}, 'IconItem')
...
Object.keys(components$1).forEach(function (key2) {
    resetComponents[key2] = reactExports.forwardRef(function (props, ref) {
...
var anchorBlockIdFromId = /* @__PURE__ */ __name(function anchorBlockIdFromId2(
    storyId
) {
...
var getComponentName = /* @__PURE__ */ __name(function getComponentName2(
    component
) {
    if (!component) {
        return void 0
...
var useMDXComponents = /* @__PURE__ */ __name(function useMDXComponents2(
    components2
) {
    var contextComponents = React__default.useContext(MDXContext)
    var allComponents = contextComponents
    if (components2) {
        allComponents = isFunction(components2)
            ? components2(contextComponents)
            : _objectSpread2(_objectSpread2({}, contextComponents), components2)
    }
...
var MDXCreateElement = /* @__PURE__ */ React__default.forwardRef(function (
    props,
    ref
) {
    var propComponents = props.components,
        ...
        etc = _objectWithoutProperties$2(props, [
            'components',
            'mdxType',
            'originalType',
            'parentName'
    ...
    var type = mdxType
    var Component =
        components2[''.concat(parentName, '.').concat(type)] ||
        components2[type] ||
        DEFAULTS[type] ||
        originalType
    if (propComponents) {
...
function _slicedToArray$3(arr, i2) {
    return (
        ...
        _iterableToArrayLimit$3(arr, i2) ||
        _unsupportedIterableToArray$4(arr, i2) ||
        _nonIterableRest$3()
    )
}
...
function useStories(storyIds, context) {
    ...
    var _useState = reactExports.useState(initialStoriesById),
            ...
            storyIds.map(
                /* @__PURE__ */ (function () {
                    var _ref = _asyncToGenerator(
                        /* @__PURE__ */ regeneratorRuntime.mark(
                            /* @__PURE__ */ __name(function _callee(storyId) {
                                var story
                                return regeneratorRuntime.wrap(
                                    /* @__PURE__ */ __name(function _callee$(
                                        _context
...
function _slicedToArray$2(arr, i2) {
    return (
        ...
        _unsupportedIterableToArray$3(arr, i2) ||
        _nonIterableRest$2()
    )
}
...
var storyBlockIdFromId = /* @__PURE__ */ __name(function storyBlockIdFromId2(
    storyId
) {
    return 'story--'.concat(storyId)
},
'storyBlockIdFromId')
var lookupStoryId = /* @__PURE__ */ __name(function lookupStoryId2(
    storyName,
    _ref
) {
    ...
    return dist.toId(
        ...
        dist.storyNameFromExport(mdxStoryNameToKey[storyName])
    )
},
'lookupStoryId')
...
var getStoryProps = /* @__PURE__ */ __name(function getStoryProps2(
    _ref4,
    story,
    context,
    onStoryFnCalled
    ...
    var _docs$inlineStories = docs.inlineStories,
        inlineStories =
            _docs$inlineStories === void 0 ? false : _docs$inlineStories,
...
var Story = /* @__PURE__ */ __name(function Story3(props) {
    var context = reactExports.useContext(DocsContext)
    var channel = addons.getChannel()
    var storyRef = reactExports.useRef()
    ...
    var _makeGate = makeGate(),
        _makeGate2 = _slicedToArray$2(_makeGate, 2),
        storyFnRan = _makeGate2[0],
        onStoryFnRan = _makeGate2[1]
    var _makeGate3 = makeGate(),
        _makeGate4 = _slicedToArray$2(_makeGate3, 2),
        rendered = _makeGate4[0],
        onRendered = _makeGate4[1]
    reactExports.useEffect(onRendered)
    if (!story) {
        return /* @__PURE__ */ React__default.createElement(StorySkeleton, null)
    }
    ...
    if (storyProps.inline) {
        ...
        if (
            !(
                window_1$1 !== null &&
                window_1$1 !== void 0 &&
                (_global$FEATURES = window_1$1.FEATURES) !== null &&
                _global$FEATURES !== void 0 &&
    ...
    return /* @__PURE__ */ React__default.createElement(
        ...
        /* @__PURE__ */ React__default.createElement(
            ...
            /* @__PURE__ */ React__default.createElement(Story$1, storyProps)
        )
    )
}, 'Story')
Story.defaultProps = {
...
var useArgs = /* @__PURE__ */ __name(function useArgs2(storyId, context) {
    ...
    var _useState = reactExports.useState(storyContext.args),
    ...
    var updateArgs = reactExports.useCallback(
    ...
    var resetArgs = reactExports.useCallback(
        function (argNames) {
...
var useGlobals = /* @__PURE__ */ __name(function useGlobals2(storyId, context) {
    var channel = addons.getChannel()
    var storyContext = getContext(storyId, context)
    var _useState3 = reactExports.useState(storyContext.globals),
...
var extractComponentArgTypes = /* @__PURE__ */ __name(
    function extractComponentArgTypes2(component, _ref, include, exclude) {
        var id = _ref.id,
...
var getComponent = /* @__PURE__ */ __name(function getComponent2() {
    ...
    var _ref3 = arguments.length > 1 ? arguments[1] : void 0,
        id = _ref3.id,
...
var addComponentTabs = /* @__PURE__ */ __name(function addComponentTabs2(
    tabs,
    components2,
    context,
    include,
    ...
    return Object.assign(
        {},
        tabs,
        mapValues(components2, function (comp) {
            return {
...
var StoryTable = /* @__PURE__ */ __name(function StoryTable2(props) {
    ...
    try {
        ...
        var _useArgs = useArgs(storyId, context),
            _useArgs2 = _slicedToArray$1(_useArgs, 3),
            args = _useArgs2[0],
            updateArgs = _useArgs2[1],
            resetArgs = _useArgs2[2]
        var _useGlobals = useGlobals(storyId, context),
            _useGlobals2 = _slicedToArray$1(_useGlobals, 1),
            globals = _useGlobals2[0]
        if (!story)
            return /* @__PURE__ */ React__default.createElement(ArgsTable$1, {
                isLoading: true,
                updateArgs,
                resetArgs
            })
        ...
        var storyHasArgsWithControls =
            argTypes &&
            Object.values(argTypes).find(function (v2) {
        ...
        if (component && (!storyHasArgsWithControls || showComponent)) {
            tabs = addComponentTabs(
                tabs,
                _defineProperty$2({}, mainLabel, component),
                context,
                include,
                exclude
            )
        ...
        return /* @__PURE__ */ React__default.createElement(TabbedArgsTable, {
            tabs,
            sort
        })
    } catch (err) {
...
var ComponentsTable = /* @__PURE__ */ __name(function ComponentsTable2(props) {
    var context = reactExports.useContext(DocsContext)
    var components2 = props.components,
        include = props.include,
        exclude = props.exclude,
        sort = props.sort
...
var ArgsTable = /* @__PURE__ */ __name(function ArgsTable3(props) {
    ...
    var _ref6 = props,
        ...
        components2 = _ref6.components,
        sortProp = _ref6.sort
    var _ref7 = props,
        storyName = _ref7.story
    var sort =
        sortProp ||
        (controls === null || controls === void 0 ? void 0 : controls.sort)
    ...
    return /* @__PURE__ */ React__default.createElement(
        ...
        _extends$3({}, props, {
            components: Object.assign(
                _defineProperty$2({}, mainLabel, main2),
                subcomponents
            ),
            sort
        })
...
var SourceContext = /* @__PURE__ */ reactExports.createContext({
    sources: {}
})
var SourceContainer = /* @__PURE__ */ __name(function SourceContainer2(_ref) {
    ...
    var channel = addons.getChannel()
    reactExports.useEffect(function () {
        var handleSnippetRendered = /* @__PURE__ */ __name(
            function handleSnippetRendered2(id, newSource) {
                var format =
                    arguments.length > 2 && arguments[2] !== void 0
                        ? arguments[2]
                        : false
...
function extractSource(location, lines) {
    var start2 = location.startBody,
        end2 = location.endBody
    ...
    return [startLine.substring(start2.col)]
        .concat(_toConsumableArray(lines.slice(start2.line, end2.line - 1)), [
            endLine.substring(0, end2.col)
        ])
        .join('\n')
}
__name(extractSource, 'extractSource')
var storyIdToSanitizedStoryName = /* @__PURE__ */ __name(
    function storyIdToSanitizedStoryName2(id) {
        return id.replace(/^.*?--/, '')
    },
    ...
    var states = stories
        .map(function (story) {
            ...
            return (_story$parameters$doc = story.parameters.docs) === null ||
                _story$parameters$doc === void 0
                ? void 0
                : (_story$parameters$doc2 = _story$parameters$doc.source) ===
                      null || _story$parameters$doc2 === void 0
                ? void 0
...
var getStorySource = /* @__PURE__ */ __name(function getStorySource2(
    storyId,
    sourceContext
) {
    var sources = sourceContext.sources
    return (
        (sources === null || sources === void 0
            ? void 0
            : sources[storyId]) || {
            code: '',
            format: false
...
var getSnippet = /* @__PURE__ */ __name(function getSnippet2(snippet, story) {
    ...
    var type =
        ((_parameters$docs = parameters.docs) === null ||
        _parameters$docs === void 0
            ? void 0
            : (_parameters$docs$sour = _parameters$docs.source) === null ||
              _parameters$docs$sour === void 0
            ? void 0
            : _parameters$docs$sour.type) || SourceType.AUTO
    var userCode =
        (_parameters$docs2 = parameters.docs) === null ||
        _parameters$docs2 === void 0
            ? void 0
            : (_parameters$docs2$sou = _parameters$docs2.source) === null ||
              _parameters$docs2$sou === void 0
            ? void 0
    ...
    if (type === SourceType.DYNAMIC) {
        ...
        return (
            ...
            _parameters$docs3 === void 0
                ? void 0
                : (_parameters$docs3$tra =
                      _parameters$docs3.transformSource) === null ||
                  _parameters$docs3$tra === void 0
                ? void 0
    ...
    if (type === SourceType.AUTO && snippet && isArgsStory) {
        ...
        return (
            ...
            _parameters$docs4 === void 0
                ? void 0
                : (_parameters$docs4$tra =
                      _parameters$docs4.transformSource) === null ||
                  _parameters$docs4$tra === void 0
                ? void 0
    ...
    return (
        (enhanced === null || enhanced === void 0
            ? void 0
            : (_enhanced$docs = enhanced.docs) === null ||
              _enhanced$docs === void 0
            ? void 0
            : (_enhanced$docs$source = _enhanced$docs.source) === null ||
              _enhanced$docs$source === void 0
            ? void 0
            : _enhanced$docs$source.code) || ''
    )
}, 'getSnippet')
var getSourceProps = /* @__PURE__ */ __name(function getSourceProps2(
    props,
    docsContext,
    sourceContext
) {
    ...
    var _docsParameters$sourc = docsParameters.source,
        sourceParameters =
            _docsParameters$sourc === void 0 ? {} : _docsParameters$sourc
    var _sourceParameters$lan = sourceParameters.language,
        docsLanguage =
            _sourceParameters$lan === void 0 ? null : _sourceParameters$lan
    return source
        ? {
              code: source,
              state,
...
var Source = /* @__PURE__ */ __name(function Source3(props) {
    var sourceContext = reactExports.useContext(SourceContext)
    var docsContext = reactExports.useContext(DocsContext)
    var sourceProps = getSourceProps(props, docsContext, sourceContext)
    return /* @__PURE__ */ React__default.createElement(Source$1, sourceProps)
}, 'Source')
...
var getPreviewProps = /* @__PURE__ */ __name(function getPreviewProps2(
    _ref,
    docsContext,
    sourceContext
) {
    ...
    var targetIds = storyChildren.map(function (s2) {
        return (
            ...
            dist.toId(
                mdxComponentAnnotations.id || mdxComponentAnnotations.title,
                dist.storyNameFromExport(mdxStoryNameToKey[s2.props.name])
            )
        )
    })
...
var getNotes = /* @__PURE__ */ __name(function getNotes2(notes) {
    return (
        ...
        (typeof notes === 'string'
            ? notes
            : str(notes.markdown) || str(notes.text))
    )
}, 'getNotes')
...
var getDescriptionProps = /* @__PURE__ */ __name(function getDescriptionProps2(
    _ref,
    _ref2
) {
    var of = _ref.of,
...
'getDescriptionProps')
var DescriptionContainer = /* @__PURE__ */ __name(
    function DescriptionContainer2(props) {
        var context = reactExports.useContext(DocsContext)
        var _getDescriptionProps = getDescriptionProps(props, context),
            markdown = _getDescriptionProps.markdown
        return markdown
            ? /* @__PURE__ */ React__default.createElement(Description$1, {
                  markdown
              })
            : null
    },
...
var Subtitle = /* @__PURE__ */ __name(function Subtitle2(_ref) {
    var children = _ref.children
    var _useContext = reactExports.useContext(DocsContext),
        id = _useContext.id,
...
var HeaderWithOcticonAnchor = /* @__PURE__ */ __name(
    function HeaderWithOcticonAnchor2(_ref3) {
        var as = _ref3.as,
            id = _ref3.id,
...
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(function (acc, headerType) {
    return Object.assign(
        {},
        acc,
        _defineProperty({}, headerType, function (props) {
            return /* @__PURE__ */ React__default.createElement(
                HeaderMdx,
                _extends$2(
                    {
...
var Subheading = /* @__PURE__ */ __name(function Subheading2(_ref) {
    ...
    if (disableAnchor || typeof children !== 'string') {
        return /* @__PURE__ */ React__default.createElement(H3, null, children)
    }
...
var DocsStory = /* @__PURE__ */ __name(function DocsStory2(_ref) {
    ...
    if (expanded && docs) {
        ...
        description =
            (_docs$description = docs.description) === null ||
            _docs$description === void 0
                ? void 0
    ...
    return /* @__PURE__ */ React__default.createElement(
        ...
        description &&
            /* @__PURE__ */ React__default.createElement(DescriptionContainer, {
        ...
        /* @__PURE__ */ React__default.createElement(
            ...
            /* @__PURE__ */ React__default.createElement(Story, {
                id,
                parameters
            })
        )
...
var Primary = /* @__PURE__ */ __name(function Primary2(_ref) {
    ...
    if (componentStories) {
        story = name
            ? componentStories.find(function (s2) {
                  return s2.name === name
              })
            : componentStories[0]
    }
...
var Stories = /* @__PURE__ */ __name(function Stories2(_ref) {
    var title = _ref.title,
        ...
        includePrimary =
            _ref$includePrimary === void 0 ? false : _ref$includePrimary
    var _useContext = reactExports.useContext(DocsContext),
    ...
    stories = stories.filter(function (story) {
        ...
        return !(
            ...
            _story$parameters !== void 0 &&
            (_story$parameters$doc = _story$parameters.docs) !== null &&
            _story$parameters$doc !== void 0 &&
    ...
    return /* @__PURE__ */ React__default.createElement(
        React__default.Fragment,
        null,
        /* @__PURE__ */ React__default.createElement(Heading, null, title),
...
var DocsPage = /* @__PURE__ */ __name(function DocsPage2() {
    return /* @__PURE__ */ React__default.createElement(
        ...
        /* @__PURE__ */ React__default.createElement(Subtitle, null),
        /* @__PURE__ */ React__default.createElement(
            DescriptionContainer,
            null
        ),
        /* @__PURE__ */ React__default.createElement(Primary, null),
        /* @__PURE__ */ React__default.createElement(ArgsTable, {
            story: PRIMARY_STORY
        }),
        /* @__PURE__ */ React__default.createElement(Stories, null)
    )
}, 'DocsPage')
...
var document$2 = window_1$1.document,
    globalWindow = window_1$1.window
var defaultComponents = Object.assign(
    {},
    components,
    {
...
var DocsContainer = /* @__PURE__ */ __name(function DocsContainer2(_ref) {
    ...
    var _storyById = storyById(storyId),
        ...
        options =
            _storyById$parameters2 === void 0 ? {} : _storyById$parameters2,
    ...
    reactExports.useEffect(
        function () {
            ...
            if (url.hash) {
                ...
                var _element =
                    document$2.getElementById(anchorBlockIdFromId(storyId)) ||
                    document$2.getElementById(storyBlockIdFromId(storyId))
                if (_element) {
                    var allStories =
...
var Preview = browser(function (props) {
    return /* @__PURE__ */ React__default.createElement(Canvas, props)
}, dedent$1(
    _templateObject$1 ||
...
var Props = browser(function (props) {
    return /* @__PURE__ */ React__default.createElement(ArgsTable, props)
}, dedent$1(
    _templateObject ||
...
export {
    ...
    __awaiter as _,
    __rest as a,
    arrayBufferNative as b,
    arrayBuffer as c,
    commonjsGlobal as d,
    dedent as e,
    _objectWithoutPropertiesLoose$3 as f,
