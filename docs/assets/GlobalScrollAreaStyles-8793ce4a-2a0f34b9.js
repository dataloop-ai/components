...
var hsResizeObserverDummyAnimation = keyframes(
    _templateObject ||
        (_templateObject = _taggedTemplateLiteral([
            '0%{z-index:0}to{z-index:-1}'
        ]))
)
var getScrollAreaStyles = /* @__PURE__ */ __name(function getScrollAreaStyles2(
    theme
) {
    return {
...
'getScrollAreaStyles')
var GlobalScrollAreaStyles = /* @__PURE__ */ __name(
    function GlobalScrollAreaStyles2() {
